...
2.  Develop your plugin code in `src/dp_tiger_v_89_parent`

    The `src/dp_tiger_v_89_parent/Plugin.tsx` is the main plugin file where you have to register all
    your custom content. However, you can create as many new files as you want under the `src/dp_tiger_v_89_parent`
...
5.  Add plugin to one or more workspaces: `npm run add-plugin -- <url>`
    ...
    Run the `npm run add-plugin -- "https://your.hosting/pluginDirOfYourChoice/dp_tiger_v_89_parent.js"` to
...
6.  Use plugin on a dashboard: `npm run link-plugin -- <plugin-object-id>`
    ...
    If your plugin supports parameterization (see [src/dp_tiger_v_89_parent](./src/dp_tiger_v_89_parent/Plugin.tsx)) and
...
This project is setup so that all your custom code must be self-contained in the [src/dp_tiger_v_89_parent](./src/dp_tiger_v_89_parent) directory.

The [src/dp_tiger_v_89_parent\_engine](./src/dp_tiger_v_89_parent_engine) and [src/dp_tiger_v_89_parent\_entry](./src/dp_tiger_v_89_parent_entry) directories contain essential plugin boilerplate.
...
You can modify minEngineVersion and maxEngineVersion properties in `src/dp_tiger_v_89_parent\_entry/index`.
