...
export declare type Header = IAttributeHeader | IMetricHeader;
export declare type WarningParameterType = boolean | number | string | null;
export interface ISimpleExecutorWarning {
    errorCode: string;
    message: string;
    parameters: WarningParameterType[];
}
export declare type MetricValue = string;
export interface IAttributeValue {
    id: string;
    name: string;
}
export declare type ResultDataType = MetricValue | IAttributeValue;
...
export declare type EmbeddedFilter = IEmbeddedDateFilter | IEmbeddedListAttributeFilter;
export declare type EmbeddedDateFilterType = "relative" | "absolute";
...
export declare type VisualizationStyleType = "common" | "table" | "line" | "column" | "bar";
...
export declare type MeasureType = "metric" | "fact" | "attribute";
...
export declare type IColorItem = IGuidColorItem | IRGBColorItem;
