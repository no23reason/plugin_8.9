...
var SDK = /** @class */ (function () {
    function SDK(fetchMethod, config) {
        ...
        var attributesMapLoaderModule = new AttributesMapLoaderModule(this.md);
        this.utils = {
            loadAttributesMap: attributesMapLoaderModule.loadAttributesMap.bind(attributesMapLoaderModule),
            getAttributesDisplayForms: getAttributesDisplayForms,
        };
    }
...
export var factory = function (fetchMethod) {
