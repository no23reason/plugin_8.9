...
import { JsonApiUserOutList, JsonApiUserGroupOutList, JsonApiWorkspaceOutList } from "./generated/metadata-json-api";
/**
 * Common parameters for all API client getEntities* parameters.
 *
 * @internal
 */
export declare type OrganizationGetEntitiesOptions = {
    headers?: object;
    query?: {
        page?: number;
        size?: number;
 ...
 * @internal
 */
export declare type OrganizationGetEntitiesResult = JsonApiUserOutList | JsonApiUserGroupOutList | JsonApiWorkspaceOutList;
/**
 * All API client getEntities* functions follow this signature.
 *
 * @internal
 */
export declare type OrganizationGetEntitiesFn<T extends OrganizationGetEntitiesResult, P> = (params: P, options: OrganizationGetEntitiesOptions) => AxiosPromise<T>;
/**
