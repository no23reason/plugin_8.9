 ...
 */
export var axios = a.create(_CONFIG);
/**
...
export function setAxiosAuthorizationToken(axios, token) {
    var _a, _b;
    if (!token) {
        var commonHeaders = (_b = (_a = axios.defaults.headers) === null || _a === void 0 ? void 0 : _a.common) !== null && _b !== void 0 ? _b : {};
        delete commonHeaders.Authorization;
    }
    else {
        var commonAuthHeader = {
            common: {
...
export function newAxios(baseUrl, headers) {
    var config = newAxiosRequestConfig(baseUrl, headers);
