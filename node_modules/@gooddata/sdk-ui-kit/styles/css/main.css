...
.bubble {
  ...
  .bubble.bubble-primary {
    ...
    border-style: solid;
    border-width: 0;
    border-color: var(--gd-tooltip-backgroundColor, var(--gd-palette-complementary-8, rgba(70, 78, 86, 0.95)));
  ...
  .bubble.bubble-primary {
    ...
    background: var(--gd-tooltip-backgroundColor, var(--gd-palette-complementary-8, rgba(70, 78, 86, 0.95))); }
    .bubble.bubble-primary .arrow-border,
    .bubble.bubble-primary .arrow {
      border-color: transparent; }
  .bubble.bubble-primary.arrow-bottom-direction .arrow-border {
    border-top-color: var(--gd-tooltip-backgroundColor, var(--gd-palette-complementary-8, rgba(70, 78, 86, 0.95))); }
  .bubble.bubble-primary.arrow-bottom-direction .arrow {
    border-top-color: var(--gd-tooltip-backgroundColor, var(--gd-palette-complementary-8, rgba(70, 78, 86, 0.95))); }
  .bubble.bubble-primary.arrow-top-direction .arrow-border {
    border-bottom-color: var(--gd-tooltip-backgroundColor, var(--gd-palette-complementary-8, rgba(70, 78, 86, 0.95))); }
  .bubble.bubble-primary.arrow-top-direction .arrow {
    border-bottom-color: var(--gd-tooltip-backgroundColor, var(--gd-palette-complementary-8, rgba(70, 78, 86, 0.95))); }
  .bubble.bubble-primary.arrow-left-direction .arrow-border {
    border-right-color: var(--gd-tooltip-backgroundColor, var(--gd-palette-complementary-8, rgba(70, 78, 86, 0.95))); }
  .bubble.bubble-primary.arrow-left-direction .arrow {
    border-right-color: var(--gd-tooltip-backgroundColor, var(--gd-palette-complementary-8, rgba(70, 78, 86, 0.95))); }
  .bubble.bubble-primary.arrow-right-direction .arrow-border {
    border-left-color: var(--gd-tooltip-backgroundColor, var(--gd-palette-complementary-8, rgba(70, 78, 86, 0.95))); }
...
/* ==========================================================================
   ...
   ========================================================================== */
.gd-button-primary, .gd-button-link.gd-button-icon-only[class*="gd-icon-"], .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"],
.gd-button-secondary, .gd-button-positive, .gd-button-negative, .gd-button-action {
  ...
  -webkit-transition-timing-function: ease-in-out;
  transition-timing-function: ease-in-out; }
  .gd-button-primary::before, .gd-button-link.gd-button-icon-only[class*="gd-icon-"]::before, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]::before,
  .gd-button-secondary::before, .gd-button-positive::before, .gd-button-negative::before, .gd-button-action::before, .gd-button-primary::after, .gd-button-link.gd-button-icon-only[class*="gd-icon-"]::after, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]::after,
  ...
  .gd-button-secondary::before, .gd-button-positive::before, .gd-button-negative::before, .gd-button-action::before {
    left: 10px;
    margin-right: 0.5em; }
  .gd-button-primary::after, .gd-button-link.gd-button-icon-only[class*="gd-icon-"]::after, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]::after,
  .gd-button-secondary::after, .gd-button-positive::after, .gd-button-negative::after, .gd-button-action::after {
    right: 7px;
    margin-left: 0.5em; }
  .gd-button-primary .gd-button-text, .gd-button-link.gd-button-icon-only[class*="gd-icon-"] .gd-button-text, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"] .gd-button-text, .gd-button-secondary .gd-button-text, .gd-button-positive .gd-button-text, .gd-button-negative .gd-button-text, .gd-button-action .gd-button-text,
  .gd-button-primary .gd-button-icon,
  .gd-button-link.gd-button-icon-only[class*="gd-icon-"] .gd-button-icon,
  .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"] .gd-button-icon,
  ...
  .gd-button-action .gd-button-icon {
    ...
    .gd-button-primary .gd-button-icon::before, .gd-button-link.gd-button-icon-only[class*="gd-icon-"] .gd-button-icon::before, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"] .gd-button-icon::before, .gd-button-secondary .gd-button-icon::before, .gd-button-positive .gd-button-icon::before, .gd-button-negative .gd-button-icon::before, .gd-button-action .gd-button-icon::before, .gd-button-primary .gd-button-icon::after, .gd-button-link.gd-button-icon-only[class*="gd-icon-"] .gd-button-icon::after, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"] .gd-button-icon::after, .gd-button-secondary .gd-button-icon::after, .gd-button-positive .gd-button-icon::after, .gd-button-negative .gd-button-icon::after, .gd-button-action .gd-button-icon::after {
      color: inherit;
      -moz-transition-property: color;
      -webkit-transition-property: color;
      transition-property: color;
      ...
      -webkit-transition-timing-function: ease-in-out;
      transition-timing-function: ease-in-out; }
  .gd-button-primary:not(.gd-button-link):not(.gd-button-link-dimmed) .gd-button-icon:first-child, .gd-button-link.gd-button-icon-only:not(.gd-button-link):not(.gd-button-link-dimmed)[class*="gd-icon-"] .gd-button-icon:first-child, .gd-button-icon-only.gd-button-link-dimmed:not(.gd-button-link):not(.gd-button-link-dimmed)[class*="gd-icon-"] .gd-button-icon:first-child, .gd-button-secondary:not(.gd-button-link):not(.gd-button-link-dimmed) .gd-button-icon:first-child, .gd-button-positive:not(.gd-button-link):not(.gd-button-link-dimmed) .gd-button-icon:first-child, .gd-button-negative:not(.gd-button-link):not(.gd-button-link-dimmed) .gd-button-icon:first-child, .gd-button-action:not(.gd-button-link):not(.gd-button-link-dimmed) .gd-button-icon:first-child {
    margin-left: -4px; }
  .gd-button-primary:not(.gd-button-link):not(.gd-button-link-dimmed) .gd-button-icon:last-child, .gd-button-link.gd-button-icon-only:not(.gd-button-link):not(.gd-button-link-dimmed)[class*="gd-icon-"] .gd-button-icon:last-child, .gd-button-icon-only.gd-button-link-dimmed:not(.gd-button-link):not(.gd-button-link-dimmed)[class*="gd-icon-"] .gd-button-icon:last-child, .gd-button-secondary:not(.gd-button-link):not(.gd-button-link-dimmed) .gd-button-icon:last-child, .gd-button-positive:not(.gd-button-link):not(.gd-button-link-dimmed) .gd-button-icon:last-child, .gd-button-negative:not(.gd-button-link):not(.gd-button-link-dimmed) .gd-button-icon:last-child, .gd-button-action:not(.gd-button-link):not(.gd-button-link-dimmed) .gd-button-icon:last-child {
    margin-right: -4px; }
  .gd-button-primary:not(.gd-button-link):not(.gd-button-link-dimmed) .gd-button-icon:only-child, .gd-button-link.gd-button-icon-only:not(.gd-button-link):not(.gd-button-link-dimmed)[class*="gd-icon-"] .gd-button-icon:only-child, .gd-button-icon-only.gd-button-link-dimmed:not(.gd-button-link):not(.gd-button-link-dimmed)[class*="gd-icon-"] .gd-button-icon:only-child, .gd-button-secondary:not(.gd-button-link):not(.gd-button-link-dimmed) .gd-button-icon:only-child, .gd-button-positive:not(.gd-button-link):not(.gd-button-link-dimmed) .gd-button-icon:only-child, .gd-button-negative:not(.gd-button-link):not(.gd-button-link-dimmed) .gd-button-icon:only-child, .gd-button-action:not(.gd-button-link):not(.gd-button-link-dimmed) .gd-button-icon:only-child {
    width: 19px;
    height: 17px;
    line-height: 17px;
    margin-right: -9px;
    margin-left: -9px;
    font-size: 16px; }
  .gd-button-primary:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active::before, .gd-button-link.gd-button-icon-only[class*="gd-icon-"]:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active::before, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active::before,
  .gd-button-secondary:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active::before, .gd-button-positive:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active::before, .gd-button-negative:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active::before, .gd-button-action:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active::before, .gd-button-primary:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active::after, .gd-button-link.gd-button-icon-only[class*="gd-icon-"]:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active::after, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active::after,
  .gd-button-secondary:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active::after, .gd-button-positive:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active::after, .gd-button-negative:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active::after, .gd-button-action:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active::after {
    top: calc(50% + 1px); }
  .gd-button-primary:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active .gd-button-text, .gd-button-link.gd-button-icon-only:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active[class*="gd-icon-"] .gd-button-text, .gd-button-icon-only.gd-button-link-dimmed:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active[class*="gd-icon-"] .gd-button-text, .gd-button-secondary:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active .gd-button-text, .gd-button-positive:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active .gd-button-text, .gd-button-negative:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active .gd-button-text, .gd-button-action:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active .gd-button-text {
    top: 2px; }
  .gd-button-primary:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active .gd-button-icon, .gd-button-link.gd-button-icon-only:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active[class*="gd-icon-"] .gd-button-icon, .gd-button-icon-only.gd-button-link-dimmed:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active[class*="gd-icon-"] .gd-button-icon, .gd-button-secondary:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active .gd-button-icon, .gd-button-positive:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active .gd-button-icon, .gd-button-negative:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active .gd-button-icon, .gd-button-action:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed):active .gd-button-icon {
    margin-top: 2px; }
  .gd-button-primary:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed) .gd-button-icon:only-child, .gd-button-link.gd-button-icon-only:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed)[class*="gd-icon-"] .gd-button-icon:only-child, .gd-button-icon-only.gd-button-link-dimmed:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed)[class*="gd-icon-"] .gd-button-icon:only-child, .gd-button-secondary:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed) .gd-button-icon:only-child, .gd-button-positive:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed) .gd-button-icon:only-child, .gd-button-negative:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed) .gd-button-icon:only-child, .gd-button-action:not(.disabled):not(.gd-button-link):not(.gd-button-link-dimmed) .gd-button-icon:only-child {
    color: var(--gd-palette-complementary-7, #778491); }
  .gd-button-primary:hover::before, .gd-button-link.gd-button-icon-only[class*="gd-icon-"]:hover::before, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]:hover::before,
  .gd-button-secondary:hover::before, .gd-button-positive:hover::before, .gd-button-negative:hover::before, .gd-button-action:hover::before, .gd-button-primary:hover::after, .gd-button-link.gd-button-icon-only[class*="gd-icon-"]:hover::after, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]:hover::after,
  ...
  .gd-button-link.gd-button-icon-only:hover[class*="gd-icon-"] .gd-button-icon,
  .gd-button-icon-only.gd-button-link-dimmed:hover[class*="gd-icon-"] .gd-button-icon,
  ...
  .gd-button-primary[class*="gd-icon-"], .gd-button-link.gd-button-icon-only[class*="gd-icon-"], .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"],
  .gd-button-secondary[class*="gd-icon-"], .gd-button-positive[class*="gd-icon-"], .gd-button-negative[class*="gd-icon-"], .gd-button-action[class*="gd-icon-"] {
    padding-left: 37px; }
    .gd-button-primary[class*="gd-icon-"].gd-icon-right, .gd-button-link.gd-button-icon-only[class*="gd-icon-"].gd-icon-right, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"].gd-icon-right,
    .gd-button-secondary[class*="gd-icon-"].gd-icon-right, .gd-button-positive[class*="gd-icon-"].gd-icon-right, .gd-button-negative[class*="gd-icon-"].gd-icon-right, .gd-button-action[class*="gd-icon-"].gd-icon-right {
      padding-left: 11px;
      padding-right: 32px; }

.gd-button-primary .ss-icon, .gd-button-link.gd-button-icon-only[class*="gd-icon-"] .ss-icon, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"] .ss-icon, .gd-button-secondary .ss-icon, .gd-button-positive .ss-icon, .gd-button-negative .ss-icon, .gd-button-action .ss-icon {
  vertical-align: middle; }
...
.gd-button-primary, .gd-button-link.gd-button-icon-only[class*="gd-icon-"], .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"],
.gd-button-secondary {
  box-shadow: var(--gd-button-dropShadow, 0 1px 1px 0) var(--gd-shadow-color, rgba(20, 56, 93, 0.15));
  color: var(--gd-palette-complementary-7, #778491);
  background: var(--gd-palette-complementary-0, #fcfcfd);
  border-color: var(--gd-palette-complementary-4, #ccd8e2); }
  .gd-button-primary:hover, .gd-button-link.gd-button-icon-only:hover[class*="gd-icon-"], .gd-button-icon-only.gd-button-link-dimmed:hover[class*="gd-icon-"],
  .gd-button-secondary:hover {
    box-shadow: 0 1px 1px 0 var(--gd-shadow-color, rgba(20, 56, 93, 0.15)), inset 0 -1px 0 0 var(--gd-shadow-color, rgba(177, 193, 209, 0.6));
    color: var(--gd-palette-complementary-8, #464e56);
    background: var(--gd-palette-complementary-1, #f5f8fa);
    border-color: var(--gd-palette-complementary-4, rgba(31, 52, 73, 0.2)); }
  .gd-button-primary:focus, .gd-button-link.gd-button-icon-only:focus[class*="gd-icon-"], .gd-button-icon-only.gd-button-link-dimmed:focus[class*="gd-icon-"], .gd-button-primary.is-focus, .is-focus.gd-button-link.gd-button-icon-only[class*="gd-icon-"], .is-focus.gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"],
  .gd-button-secondary:focus,
  .gd-button-secondary.is-focus {
    box-shadow: var(--gd-button-dropShadow, 0 0 3px 1px) rgba(69, 199, 239, 0), var(--gd-button-dropShadow, 0 1px 2px 0) var(--gd-shadow-color, rgba(20, 56, 93, 0.15)), inset 0 -1px 0 0 var(--gd-shadow-color, rgba(177, 193, 209, 0.6));
    border-color: var(--gd-palette-primary-base-t25, rgba(20, 178, 226, 0.75)); }
  .gd-button-primary:active, .gd-button-link.gd-button-icon-only:active[class*="gd-icon-"], .gd-button-icon-only.gd-button-link-dimmed:active[class*="gd-icon-"], .gd-button-primary.is-active, .is-active.gd-button-link.gd-button-icon-only[class*="gd-icon-"], .is-active.gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"],
  .gd-button-secondary:active,
  .gd-button-secondary.is-active {
    box-shadow: inset 0 1px 0 0 var(--gd-shadow-color, rgba(177, 193, 209, 0.65));
    color: var(--gd-palette-complementary-8, #464e56);
...
.gd-button-positive,
.gd-button-negative,
.gd-button-action, .gd-button-primary, .gd-button-link.gd-button-icon-only[class*="gd-icon-"], .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"] {
  font-weight: 700; }

.gd-button-positive {
  box-shadow: var(--gd-button-dropShadow, 0 1px 1px 0) var(--gd-shadow-color, rgba(20, 56, 93, 0.09));
  ...
  .gd-button-positive:focus {
    box-shadow: var(--gd-button-dropShadow, 0 0 3px 1px) var(--gd-palette-success-focus, rgba(0, 224, 163, 0.5)), var(--gd-button-dropShadow, 0 1px 1px 0) var(--gd-shadow-color, rgba(20, 56, 93, 0.15)), inset 0 -2px 0 0 rgba(0, 0, 0, 0.15); }
  .gd-button-positive:active, .gd-button-positive.is-active {
    box-shadow: inset 0 2px 0 0 rgba(0, 0, 0, 0.15);
    background: var(--gd-palette-success-base-d06, #00a277);
    /* Old browsers */
    background-image: -webkit-linear-gradient(top, var(--gd-palette-success-base-d12, #008460), var(--gd-palette-success-base-d06, #00a277));
    /* Chrome 10+, Saf5.1+ */
    background-image: -moz-linear-gradient(top, var(--gd-palette-success-base-d12, #008460), var(--gd-palette-success-base-d06, #00a277));
    /* FF3.6 */
    background-image: -ms-linear-gradient(top, var(--gd-palette-success-base-d12, #008460), var(--gd-palette-success-base-d06, #00a277));
    /* IE10 */
...
.gd-button-negative {
  ...
  .gd-button-negative:focus {
    box-shadow: var(--gd-button-dropShadow, 0 0 3px 1px) var(--gd-palette-error-focus, rgba(235, 119, 111, 0.6)), var(--gd-button-dropShadow, 0 1px 1px 0) var(--gd-shadow-color, rgba(20, 56, 93, 0.15)), inset 0 -1px 0 0 rgba(0, 0, 0, 0.15); }
  .gd-button-negative:active, .gd-button-negative.is-active {
    box-shadow: inset 0 2px 0 0 rgba(0, 0, 0, 0.15);
    background: var(--gd-palette-error-base-d10, #d62a1e);
    /* Old browsers */
    background-image: -webkit-linear-gradient(top, var(--gd-palette-error-base-d20, #aa2117), var(--gd-palette-error-base-d10, #d62a1e));
    /* Chrome 10+, Saf5.1+ */
    background-image: -moz-linear-gradient(top, var(--gd-palette-error-base-d20, #aa2117), var(--gd-palette-error-base-d10, #d62a1e));
    /* FF3.6 */
    background-image: -ms-linear-gradient(top, var(--gd-palette-error-base-d20, #aa2117), var(--gd-palette-error-base-d10, #d62a1e));
    /* IE10 */
    background-image: linear-gradient(to top, var(--gd-palette-error-base-d20, #aa2117), var(--gd-palette-error-base-d10, #d62a1e)); }

.gd-button-action {
  box-shadow: var(--gd-button-dropShadow, 1px 1px 0) var(--gd-shadow-color, rgba(20, 56, 93, 0.09));
  ...
  .gd-button-action:active, .gd-button-action.is-active {
    ...
    background: var(--gd-palette-primary-base-d06, #129cc6);
    /* Old browsers */
    background-image: -webkit-linear-gradient(top, var(--gd-palette-primary-base-d12, #0f86aa), var(--gd-palette-primary-base-d06, #129cc6));
    /* Chrome 10+, Saf5.1+ */
    background-image: -moz-linear-gradient(top, var(--gd-palette-primary-base-d12, #0f86aa), var(--gd-palette-primary-base-d06, #129cc6));
    /* FF3.6 */
    background-image: -ms-linear-gradient(top, var(--gd-palette-primary-base-d12, #0f86aa), var(--gd-palette-primary-base-d06, #129cc6));
    /* IE10 */
    background-image: linear-gradient(to top, var(--gd-palette-primary-base-d12, #0f86aa), var(--gd-palette-primary-base-d06, #129cc6)); }

/* Button links
   ========================================================================== */
.gd-button-link[class*="gd-icon-"], .gd-button-link-dimmed[class*="gd-icon-"] {
  position: relative;
  padding-left: 32px; }

.gd-button-link[class*="gd-icon-"].gd-icon-right, .gd-button-link-dimmed[class*="gd-icon-"].gd-icon-right {
  padding-left: 11px;
  padding-right: 30px; }
  .gd-button-link[class*="gd-icon-"].gd-icon-right::after, .gd-button-link-dimmed[class*="gd-icon-"].gd-icon-right::after {
    position: absolute;
    right: 5px;
    font-size: 18px; }
...
.gd-button-link-dimmed {
  ...
  .gd-button-link-dimmed.is-active, .gd-button-link-dimmed:hover, .gd-button-link-dimmed:focus, .gd-button-link-dimmed:active {
    color: var(--gd-palette-complementary-8, #000); }
  .gd-button-link-dimmed .gd-button-text {
    text-decoration: underline; }

.gd-button-link.gd-button-icon-only[class*="gd-icon-"], .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"] {
  width: 31px;
  height: 29px;
  line-height: 27px; }
  .gd-button-link.gd-button-icon-only[class*="gd-icon-"], .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"], .gd-button-link.gd-button-icon-only[class*="gd-icon-"]:hover, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]:hover, .gd-button-link.gd-button-icon-only[class*="gd-icon-"]:focus, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]:focus, .gd-button-link.gd-button-icon-only[class*="gd-icon-"]:active, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]:active {
    border: 0;
    box-shadow: none;
    background: none;
    padding-left: 0; }
  .gd-button-link.gd-button-icon-only[class*="gd-icon-"].gd-button-small::before, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"].gd-button-small::before {
    font-size: 16px; }
  .gd-button-link.gd-button-icon-only[class*="gd-icon-"]::before, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]::before,
  .gd-button-link.gd-button-icon-only[class*="gd-icon-"] .gd-button-icon,
  .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"] .gd-button-icon {
    color: var(--gd-palette-complementary-7, #6d7680); }
  .gd-button-link.gd-button-icon-only[class*="gd-icon-"]:active::before, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]:active::before,
  .gd-button-link.gd-button-icon-only[class*="gd-icon-"]:active .gd-button-icon,
  .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]:active .gd-button-icon {
    color: var(--gd-palette-primary-base-d06, #129cc6); }
  .gd-button-link.gd-button-icon-only[class*="gd-icon-"]:focus::before, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]:focus::before,
  .gd-button-link.gd-button-icon-only[class*="gd-icon-"]:focus .gd-button-icon,
  .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]:focus .gd-button-icon, .gd-button-link.gd-button-icon-only[class*="gd-icon-"]:hover::before, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]:hover::before,
  .gd-button-link.gd-button-icon-only[class*="gd-icon-"]:hover .gd-button-icon,
  .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]:hover .gd-button-icon {
    color: var(--gd-palette-primary-base, #14b2e2); }
  .gd-button-link.gd-button-icon-only[class*="gd-icon-"].disabled::before, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"].disabled::before,
  .gd-button-link.gd-button-icon-only[class*="gd-icon-"].disabled .gd-button-icon,
  .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"].disabled .gd-button-icon, .gd-button-link.gd-button-icon-only[class*="gd-icon-"].disabled:hover::before, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"].disabled:hover::before,
  .gd-button-link.gd-button-icon-only[class*="gd-icon-"].disabled:hover .gd-button-icon,
  .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"].disabled:hover .gd-button-icon, .gd-button-link.gd-button-icon-only[class*="gd-icon-"].disabled:focus::before, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"].disabled:focus::before,
  .gd-button-link.gd-button-icon-only[class*="gd-icon-"].disabled:focus .gd-button-icon,
  .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"].disabled:focus .gd-button-icon, .gd-button-link.gd-button-icon-only[class*="gd-icon-"].disabled:active::before, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"].disabled:active::before,
  .gd-button-link.gd-button-icon-only[class*="gd-icon-"].disabled:active .gd-button-icon,
  .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"].disabled:active .gd-button-icon {
    color: var(--gd-palette-complementary-5, #b0beca); }
...
.gd-button-primary.disabled, .disabled.gd-button-link.gd-button-icon-only[class*="gd-icon-"], .disabled.gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"],
.gd-button-secondary.disabled {
  cursor: default; }
  .gd-button-primary.disabled, .disabled.gd-button-link.gd-button-icon-only[class*="gd-icon-"], .disabled.gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"], .gd-button-primary.disabled:hover, .disabled.gd-button-link.gd-button-icon-only:hover[class*="gd-icon-"], .disabled.gd-button-icon-only.gd-button-link-dimmed:hover[class*="gd-icon-"], .gd-button-primary.disabled:focus, .disabled.gd-button-link.gd-button-icon-only:focus[class*="gd-icon-"], .disabled.gd-button-icon-only.gd-button-link-dimmed:focus[class*="gd-icon-"], .gd-button-primary.disabled:active, .disabled.gd-button-link.gd-button-icon-only:active[class*="gd-icon-"], .disabled.gd-button-icon-only.gd-button-link-dimmed:active[class*="gd-icon-"],
  .gd-button-secondary.disabled,
  ...
  .gd-button-secondary.disabled:active {
    ...
    .gd-button-primary.disabled::before, .disabled.gd-button-link.gd-button-icon-only[class*="gd-icon-"]::before, .disabled.gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]::before, .gd-button-primary.disabled::after, .disabled.gd-button-link.gd-button-icon-only[class*="gd-icon-"]::after, .disabled.gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]::after,
    .gd-button-primary.disabled .gd-button-icon,
    .disabled.gd-button-link.gd-button-icon-only[class*="gd-icon-"] .gd-button-icon,
    .disabled.gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"] .gd-button-icon, .gd-button-primary.disabled:hover::before, .disabled.gd-button-link.gd-button-icon-only[class*="gd-icon-"]:hover::before, .disabled.gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]:hover::before, .gd-button-primary.disabled:hover::after, .disabled.gd-button-link.gd-button-icon-only[class*="gd-icon-"]:hover::after, .disabled.gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]:hover::after,
    .gd-button-primary.disabled:hover .gd-button-icon,
    .disabled.gd-button-link.gd-button-icon-only:hover[class*="gd-icon-"] .gd-button-icon,
    .disabled.gd-button-icon-only.gd-button-link-dimmed:hover[class*="gd-icon-"] .gd-button-icon, .gd-button-primary.disabled:focus::before, .disabled.gd-button-link.gd-button-icon-only[class*="gd-icon-"]:focus::before, .disabled.gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]:focus::before, .gd-button-primary.disabled:focus::after, .disabled.gd-button-link.gd-button-icon-only[class*="gd-icon-"]:focus::after, .disabled.gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]:focus::after,
    .gd-button-primary.disabled:focus .gd-button-icon,
    .disabled.gd-button-link.gd-button-icon-only:focus[class*="gd-icon-"] .gd-button-icon,
    .disabled.gd-button-icon-only.gd-button-link-dimmed:focus[class*="gd-icon-"] .gd-button-icon, .gd-button-primary.disabled:active::before, .disabled.gd-button-link.gd-button-icon-only[class*="gd-icon-"]:active::before, .disabled.gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]:active::before, .gd-button-primary.disabled:active::after, .disabled.gd-button-link.gd-button-icon-only[class*="gd-icon-"]:active::after, .disabled.gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]:active::after,
    .gd-button-primary.disabled:active .gd-button-icon,
    .disabled.gd-button-link.gd-button-icon-only:active[class*="gd-icon-"] .gd-button-icon,
    .disabled.gd-button-icon-only.gd-button-link-dimmed:active[class*="gd-icon-"] .gd-button-icon,
...
.gd-button-link.gd-button-icon-only[class*="gd-icon-"]::before, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]::before, .gd-button-link.gd-button-icon-only[class*="gd-icon-"]::after, .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"]::after {
  right: 0;
  left: 0;
  margin: 0 auto;
  padding: 0; }
...
.gd-datepicker {
  ...
  .gd-datepicker.small .input-text {
    padding-left: 30px; }
  .gd-datepicker.small .gd-datepicker-icon {
    left: 8px;
    line-height: 28px;
    font-size: 15px; }
  .gd-datepicker.gd-datepicker-focused .input-text,
  .gd-datepicker.gd-datepicker-focused .gd-datepicker-icon {
    z-index: 11; }
...
.gd-datepicker-OverlayWrapper-xx-bl {
  position: relative; }
  .gd-datepicker-OverlayWrapper-xx-tl .gd-datepicker-picker,
  .gd-datepicker-OverlayWrapper-xx-bl .gd-datepicker-picker {
    left: 0; }

.gd-datepicker-OverlayWrapper-xx-tr,
.gd-datepicker-OverlayWrapper-xx-br {
  position: relative; }
  .gd-datepicker-OverlayWrapper-xx-tr .gd-datepicker-picker,
  .gd-datepicker-OverlayWrapper-xx-br .gd-datepicker-picker {
    right: 0;
    left: auto; }
...
.gd-datepicker-OverlayWrapper-br-xx {
  position: relative; }
  .gd-datepicker-OverlayWrapper-bl-xx .gd-datepicker-picker,
  .gd-datepicker-OverlayWrapper-br-xx .gd-datepicker-picker {
    top: 0; }

.gd-datepicker-OverlayWrapper-tl-xx,
.gd-datepicker-OverlayWrapper-tr-xx {
  position: static; }
  .gd-datepicker-OverlayWrapper-tl-xx .gd-datepicker-picker,
  .gd-datepicker-OverlayWrapper-tr-xx .gd-datepicker-picker {
    top: auto;
    bottom: 100%;
    box-shadow: 0 0 5px 0 var(--gd-shadow-color, rgba(31, 53, 74, 0.15)); }
...
.gd-datepicker-picker {
  ...
  user-select: none;
  text-align: left;
  box-shadow: 0 2px 5px 0 var(--gd-shadow-color, rgba(31, 53, 74, 0.15)); }
  .gd-datepicker-picker .DayPicker {
    position: relative;
    display: flex;
    justify-content: center;
    flex-wrap: wrap;
    user-select: none; }
  .gd-datepicker-picker .DayPicker-Month {
    display: table;
    border-spacing: 0;
    border-collapse: collapse;
    user-select: none; }
  .gd-datepicker-picker .DayPicker-NavBar {
    position: absolute;
    right: 0;
    left: 0;
    padding: 0 0.5rem; }
  .gd-datepicker-picker .DayPicker-NavButton {
    position: absolute;
    width: 1.5rem;
    height: 1.5rem;
    cursor: pointer;
    ...
    background-position: center;
    background-size: contain; }
  .gd-datepicker-picker .DayPicker-NavButton--prev,
  .gd-datepicker-picker .DayPicker-NavButton--next {
    position: absolute;
    top: -0.25em;
    ...
    height: 2em;
    text-align: center; }
    .gd-datepicker-picker .DayPicker-NavButton--prev::before,
    .gd-datepicker-picker .DayPicker-NavButton--next::before {
      display: block;
      color: var(--gd-palette-primary-base, #14b2e2);
      padding-top: 0.15em;
      font-family: "Indigo", sans-serif;
      font-size: 18px; }
    .gd-datepicker-picker .DayPicker-NavButton--prev:hover::before,
    .gd-datepicker-picker .DayPicker-NavButton--next:hover::before {
      color: var(--gd-palette-complementary-6, #94a1ad); }
  .gd-datepicker-picker .DayPicker-NavButton--prev {
    left: 0.15em; }
    .gd-datepicker-picker .DayPicker-NavButton--prev::before {
  ...
  .gd-datepicker-picker .DayPicker-NavButton--next {
    ...
    .gd-datepicker-picker .DayPicker-NavButton--next::before {
      content: "\e631"; }
  .gd-datepicker-picker .DayPicker-NavButton--next:hover,
  .gd-datepicker-picker .DayPicker-NavButton--prev:hover {
    color: var(--gd-palette-primary-base, #14b2e2);
    cursor: pointer; }
  .gd-datepicker-picker .DayPicker-Caption {
    ...
    font-size: 17px;
    text-align: center; }
  .gd-datepicker-picker .DayPicker-Weekdays {
    display: table-header-group; }
  .gd-datepicker-picker .DayPicker-WeekdaysRow {
    display: table-row; }
  .gd-datepicker-picker .DayPicker-Weekday {
    display: table-cell;
    color: var(--gd-palette-complementary-8, #94a1ad);
    cursor: help;
    ...
    font-size: 13px;
    text-align: center; }
    .gd-datepicker-picker .DayPicker-Weekday abbr {
      text-decoration: none;
      border-bottom: none; }
  .gd-datepicker-picker .DayPicker-Body {
    display: table-row-group; }
  .gd-datepicker-picker .DayPicker-Week {
    display: table-row; }
  .gd-datepicker-picker .DayPicker-Day {
    display: table-cell;
    ...
    font-weight: 700;
    text-align: center; }
    .gd-datepicker-picker .DayPicker-Day:hover {
      background: var(--gd-palette-complementary-2, #ebeff4);
      cursor: pointer; }
  .gd-datepicker-picker .DayPicker--interactionDisabled .DayPicker-Day {
    cursor: default; }
  .gd-datepicker-picker .DayPicker-Day--disabled {
    color: var(--gd-palette-complementary-5, #b0beca);
    cursor: default;
    font-weight: 400; }
  .gd-datepicker-picker .DayPicker-Day--outside {
    color: var(--gd-palette-complementary-5, #b0beca);
    cursor: default;
    font-weight: 400; }
  .gd-datepicker-picker .DayPicker-Day--selected:not(.DayPicker-Day--disabled):not(.DayPicker-Day--outside) {
    color: var(--gd-palette-complementary-0, #fff);
    background: var(--gd-palette-primary-base, #14b2e2); }
...
.modalityPlugin-mask {
  ...
  height: 100%;
  opacity: 0.9;
  background-color: var(--gd-modal-outsideBackgroundColor, var(--gd-palette-complementary-2, #eff1f3)); }
...
.overlay.gd-dialog:not(.gd-dropdown) {
  ...
  box-shadow: var(--gd-modal-dropShadow, 0 1px 20px) var(--gd-shadow-color, rgba(20, 56, 93, 0.15));
  /**
  ...
  .gd-dialog:not(.gd-dropdown) .gd-dialog-close.gd-button-link-dimmed,
  .overlay.gd-dialog:not(.gd-dropdown) .gd-dialog-close,
  .overlay.gd-dialog:not(.gd-dropdown) .gd-dialog-close.gd-button-link,
  .overlay.gd-dialog:not(.gd-dropdown) .gd-dialog-close.gd-button-link-dimmed {
    position: absolute;
    z-index: 5;
    top: 14px;
    right: 4px;
    ...
    .gd-dialog:not(.gd-dropdown) .gd-dialog-close.gd-button-link-dimmed::before,
    ...
    .overlay.gd-dialog:not(.gd-dropdown) .gd-dialog-close.gd-button-link-dimmed::before {
      color: var(--gd-palette-complementary-7, #6d7680); }
    ...
    .gd-dialog:not(.gd-dropdown) .gd-dialog-close.gd-button-link-dimmed:hover,
    .gd-dialog:not(.gd-dropdown) .gd-dialog-close.gd-button-link:focus,
    .gd-dialog:not(.gd-dropdown) .gd-dialog-close.gd-button-link-dimmed:focus,
    .gd-dialog:not(.gd-dropdown) .gd-dialog-close.gd-button-link:active,
    .gd-dialog:not(.gd-dropdown) .gd-dialog-close.gd-button-link-dimmed:active,
    ...
    .overlay.gd-dialog:not(.gd-dropdown) .gd-dialog-close.gd-button-link-dimmed:hover,
    .overlay.gd-dialog:not(.gd-dropdown) .gd-dialog-close.gd-button-link:focus,
    .overlay.gd-dialog:not(.gd-dropdown) .gd-dialog-close.gd-button-link-dimmed:focus,
    .overlay.gd-dialog:not(.gd-dropdown) .gd-dialog-close.gd-button-link:active,
    .overlay.gd-dialog:not(.gd-dropdown) .gd-dialog-close.gd-button-link-dimmed:active {
      box-shadow: none;
      border-color: transparent; }
      ...
      .gd-dialog:not(.gd-dropdown) .gd-dialog-close.gd-button-link-dimmed:hover::before,
      .gd-dialog:not(.gd-dropdown) .gd-dialog-close.gd-button-link:focus::before,
      .gd-dialog:not(.gd-dropdown) .gd-dialog-close.gd-button-link-dimmed:focus::before,
      .gd-dialog:not(.gd-dropdown) .gd-dialog-close.gd-button-link:active::before,
      .gd-dialog:not(.gd-dropdown) .gd-dialog-close.gd-button-link-dimmed:active::before,
      ...
      .overlay.gd-dialog:not(.gd-dropdown) .gd-dialog-close.gd-button-link-dimmed:hover::before,
      .overlay.gd-dialog:not(.gd-dropdown) .gd-dialog-close.gd-button-link:focus::before,
      .overlay.gd-dialog:not(.gd-dropdown) .gd-dialog-close.gd-button-link-dimmed:focus::before,
      .overlay.gd-dialog:not(.gd-dropdown) .gd-dialog-close.gd-button-link:active::before,
      .overlay.gd-dialog:not(.gd-dropdown) .gd-dialog-close.gd-button-link-dimmed:active::before {
        color: var(--gd-palette-primary-base, #14b2e2); }
...
.overlay.gd-dialog.conversion-touch-point-dialog .hubspot-form textarea.hs-input {
  ...
  .overlay.gd-dialog.conversion-touch-point-dialog .hubspot-form textarea.hs-input:hover {
    border-color: #b1c1d1; }
  .overlay.gd-dialog.conversion-touch-point-dialog .hubspot-form textarea.hs-input:focus {
    outline: 0;
...
.input-text {
  ...
  .input-text::-webkit-input-placeholder {
    color: var(--gd-palette-complementary-6, rgba(109, 118, 128, 0.75));
    -moz-transition-property: color;
    -webkit-transition-property: color;
    transition-property: color;
    -moz-transition-duration: 0.25s;
...
.has-error .gd-input-field {
  color: var(--gd-palette-complementary-8, #464e56);
  border-color: var(--gd-palette-error-base-t50, rgba(229, 77, 66, 0.5));
  box-shadow: inset 0 0 2px 0 var(--gd-palette-error-base-t70d20, rgba(170, 33, 23, 0.3)); }

.has-error .gd-input-icon {
  color: var(--gd-palette-error-base, #e54d42); }

.has-warning .gd-input-field {
  border-color: var(--gd-palette-warning-base, #fada23);
  box-shadow: inset 0 0 2px 0 var(--gd-palette-warning-base-t70d20, rgba(179, 153, 4, 0.3)); }
...
.gd-input-suffix {
  ...
  -webkit-transition-timing-function: ease-in-out;
  transition-timing-function: ease-in-out;
  color: var(--gd-palette-complementary-6, #b0beca);
  min-width: 30px;
  text-align: center;
  background-color: var(--gd-palette-complementary-1, #fcfcfd); }
...
.input-checkbox-label {
  ...
  .input-checkbox-label .input-label-text {
    ...
    .input-checkbox-label .input-label-text::before {
      ...
      width: 12px;
      height: 12px;
      border: 1px solid var(--gd-palette-complementary-5, #b1c1d1);
      transition: all 0.2s;
  ...
  .input-checkbox-label:active input.disabled ~ .input-label-text::before {
    box-shadow: none;
    border-color: var(--gd-palette-complementary-3, rgba(204, 216, 226, 0.7));
    background-color: var(--gd-palette-complementary-0, #fcfcfd); }
...
.input-checkbox-toggle .input-label-text {
  ...
  .input-checkbox-toggle .input-label-text::before, .input-checkbox-toggle .input-label-text::after {
    ...
    position: absolute;
    box-sizing: content-box;
    background: var(--gd-palette-complementary-0, #f3f6f7);
    cursor: pointer;
    transition: all 0.4s; }
  .input-checkbox-toggle .input-label-text::before {
    ...
    width: 28px;
    height: 12px;
    border: 1px solid var(--gd-palette-complementary-4, #c9d5e0);
    border-radius: 7px; }
...
.input-checkbox-toggle:hover .input-label-text::after, .input-checkbox-toggle:active .input-label-text::after {
  border: 1px solid var(--gd-palette-complementary-5, #94a1ad);
  background: var(--gd-palette-complementary-3, #d7dfe5); }
...
.input-checkbox-toggle:active input.disabled ~ .input-label-text::after {
  box-shadow: none;
  cursor: default;
  border-color: var(--gd-palette-complementary-3, rgba(204, 216, 226, 0.5));
  background-color: var(--gd-palette-complementary-0, #fcfcfd); }
  ...
  .gd-measure-custom-format-dialog-body .gd-measure-custom-format-dialog-content {
    ...
    .gd-measure-custom-format-dialog-body .gd-measure-custom-format-dialog-content .gd-measure-format-button-templates {
      ...
      .gd-measure-custom-format-dialog-body .gd-measure-custom-format-dialog-content .gd-measure-format-button-templates:hover {
        color: var(--gd-palette-primary-base-darken20, #0c6884); }
...
.gd-timepicker {
  display: inline-block; }
  .gd-timepicker .button-dropdown {
    width: 100%; }
  .gd-timepicker .gd-icon-timer,
  .gd-timepicker .button-dropdown .gd-icon-timer,
  .gd-timepicker .button-dropdown:focus .gd-icon-timer,
  .gd-timepicker .button-dropdown:hover .gd-icon-timer,
  .gd-timepicker .button-dropdown.is-active .gd-icon-timer {
    color: var(--gd-palette-primary-base, #14b2e2); }

.gd-mobile-dropdown-header .button-dropdown.is-active .gd-button-icon.gd-icon-timer {
  color: var(--gd-palette-primary-base, #14b2e2); }
...
.gd-vis-type, .gd-vis-type-area, .gd-vis-type-bar, .gd-vis-type-bubble, .gd-vis-type-column, .gd-vis-type-combo, .gd-vis-type-combo2, .gd-vis-type-donut, .gd-vis-type-dual, .gd-vis-type-funnel, .gd-vis-type-headline, .gd-vis-type-heatmap, .gd-vis-type-line, .gd-vis-type-pie, .gd-vis-type-scatter, .gd-vis-type-table, .gd-vis-type-treemap, .gd-vis-type-unknown, .gd-vis-type-xirr, .gd-vis-type-pushpin, .gd-vis-type-region, .gd-vis-type-bullet {
  display: inline-block;
  width: 32px;
  height: 30px;
  vertical-align: top;
  ...
  .is-selected .gd-vis-type, .is-selected .gd-vis-type-area, .is-selected .gd-vis-type-bar, .is-selected .gd-vis-type-bubble, .is-selected .gd-vis-type-column, .is-selected .gd-vis-type-combo, .is-selected .gd-vis-type-combo2, .is-selected .gd-vis-type-donut, .is-selected .gd-vis-type-dual, .is-selected .gd-vis-type-funnel, .is-selected .gd-vis-type-headline, .is-selected .gd-vis-type-heatmap, .is-selected .gd-vis-type-line, .is-selected .gd-vis-type-pie, .is-selected .gd-vis-type-scatter, .is-selected .gd-vis-type-table, .is-selected .gd-vis-type-treemap, .is-selected .gd-vis-type-unknown, .is-selected .gd-vis-type-xirr, .is-selected .gd-vis-type-pushpin, .is-selected .gd-vis-type-region, .is-selected .gd-vis-type-bullet {
...
.gd-visualizations-list-item {
  ...
  .gd-visualizations-list-item:hover {
    ...
    box-shadow: 0 1px 3px 0 var(--gd-shadow-color, rgba(20, 56, 93, 0.09)), 0 2px 9px 0 var(--gd-shadow-color, rgba(20, 56, 93, 0.15));
    background-color: var(--gd-palette-complementary-0, #fff); }
  .gd-visualizations-list-item.is-selected .gd-visualizations-list-item-content {
    font-weight: bold; }
    .gd-visualizations-list-item.is-selected .gd-visualizations-list-item-content .gd-visualizations-list-item-content-name {
      color: var(--gd-palette-primary-base, #14b2e2); }
  .gd-visualizations-list-item .gd-visualizations-list-item-content {
    display: inline-block;
    overflow: hidden;
    vertical-align: middle; }
    .gd-visualizations-list-item .gd-visualizations-list-item-content .gd-visualizations-list-item-content-name,
    .gd-visualizations-list-item .gd-visualizations-list-item-content .gd-visualizations-list-item-content-date {
      margin-top: 2px; }
    .gd-visualizations-list-item .gd-visualizations-list-item-content .gd-visualizations-list-item-content-name {
      line-height: 14px;
      color: var(--gd-palette-complementary-8, #464e56);
      font-size: 12px; }
      .gd-visualizations-list-item .gd-visualizations-list-item-content .gd-visualizations-list-item-content-name span {
        display: inline-block;
        width: 100%; }
    .gd-visualizations-list-item .gd-visualizations-list-item-content .gd-visualizations-list-item-content-date {
      line-height: 12px;
      ...
      font-size: 10px;
      text-transform: uppercase; }
  .gd-visualizations-list-item .gd-vis-type {
    flex: 0 0 32px; }
  .gd-visualizations-list-item .gd-visualizations-list-item-actions {
    flex: 0 0 40px; }
  .gd-visualizations-list-item .gd-icon-lock {
    color: var(--gd-palette-complementary-6, #94a1ad);
    margin-right: 4px; }

.gd-visualizations-list-item-actions {
  opacity: 0; }
  .gd-visualizations-list-item:hover .gd-visualizations-list-item-actions {
    opacity: 1; }
...
.gd-tab {
  ...
  text-align: center; }
  .gd-tab:hover {
    color: var(--gd-palette-complementary-8, var(--gd-palette-complementary-9, #000));
...
.gd-header-logo {
  ...
  -webkit-transition-duration: 0.2s;
  transition-duration: 0.2s; }
  .gd-header-logo.active {
    cursor: default; }
  .gd-header-logo:not(.active):hover, .gd-header-logo:not(.active):focus, .gd-header-logo:not(.active):active {
    opacity: 0.6; }
  .gd-header-logo img {
    width: auto;
    height: auto;
...
.gd-header-menu-section {
  ...
  margin: 0;
  padding: 0 11px; }
  .gd-header-menu-section + .gd-header-menu-section {
...
.gd-header-menu-vertical-wrapper {
  ...
  white-space: nowrap;
  color: var(--gd-palette-complementary-6, #94a1ad);
  background-color: var(--gd-palette-complementary-1, #2c343f); }
  .gd-header-menu-vertical-wrapper * {
    box-sizing: border-box; }
...
.gd-header-menu-vertical li a {
  ...
  cursor: pointer;
  font-size: 16px; }
  .gd-header-menu-vertical li a::before, .gd-header-menu-vertical li a::after {
    content: "";
    position: absolute;
    display: block; }
  .gd-header-menu-vertical li a::before {
    top: 0;
    bottom: 0;
    left: 0;
    width: 4px; }
  .gd-header-menu-vertical li a::after {
    right: 15px;
    bottom: -1px;
    left: 15px;
    height: 1px;
    border-bottom: 1px solid var(--gd-palette-complementary-4, rgba(148, 161, 173, 0.2)); }
  .gd-header-menu-vertical li a:hover {
    border: none;
    color: var(--gd-palette-complementary-9, #fff); }
    .gd-header-menu-vertical li a:hover::before {
      background-color: var(--gd-palette-complementary-6, inherit); }
    .gd-header-menu-vertical li a:hover::after {
      display: none; }
  .gd-header-menu-vertical li a.active {
    border: none;
    color: var(--gd-palette-complementary-9, #fff);
    background-color: var(--gd-palette-complementary-0, #131c28);
    font-weight: bold; }
    .gd-header-menu-vertical li a.active::after {
      display: none; }
    .gd-header-menu-vertical li a.active::before {
      background-color: var(--gd-palette-primary-base, #14b2e2); }
...
.gd-header-menu-vertical-content {
  ...
  overflow-x: hidden;
  overflow-y: auto;
  border-top: 1px solid var(--gd-palette-complementary-4, rgba(148, 161, 173, 0.2)); }
...
.gd-header-menu-item {
  ...
  -webkit-transition-duration: 0.2s;
  transition-duration: 0.2s; }
  .gd-header-menu-item, .gd-header-menu-item:hover, .gd-header-menu-item:focus, .gd-header-menu-item:active {
    color: inherit;
    opacity: 1;
    text-decoration: none; }
  .gd-header-menu-item:hover, .gd-header-menu-item:focus, .gd-header-menu-item:active, .gd-header-menu-item.active {
    border-bottom-width: 3px;
    border-bottom-style: solid; }
  .gd-header-menu-item, .gd-header-menu-item:active {
    opacity: 0.8; }
  .gd-header-menu-item.active {
    opacity: 1;
    border-color: var(--gd-palette-primary-base, #14b2e2);
    font-weight: 700; }
...
.gd-header-project-wrapper {
  ...
  max-width: 230px; }
  .gd-header-project-wrapper,
  .gd-header-project-wrapper div:first-child {
    overflow: hidden; }
  .gd-header-project-wrapper > div:first-child {
    flex: inherit;
    max-width: inherit; }
...
.gd-header-project {
  ...
  white-space: nowrap;
  text-overflow: ellipsis; }
  .gd-header-project.is-collapsed, .gd-header-project.is-expanded {
    cursor: pointer; }
    .gd-header-project.is-collapsed:hover, .gd-header-project.is-expanded:hover {
      background: rgba(255, 255, 255, 0.3); }
    .gd-header-project.is-collapsed::after, .gd-header-project.is-expanded::after {
      position: absolute;
      top: 0;
      right: 11px;
      width: 12px;
      ...
      font-family: "Indigo", sans-serif;
      text-align: center; }
  .gd-header-project.is-collapsed::after {
    content: "\E612"; }
  .gd-header-project.is-expanded::after {
    content: "\E613"; }
...
.gd-header-shrink {
  flex: 0 1 auto; }
  .gd-header-shrink ~ .gd-header-project-wrapper {
    flex: 1 1 auto;
    max-width: none; }
...
.gd-header-help {
  ...
  white-space: nowrap;
  text-overflow: ellipsis; }
  .gd-header-account:hover, .gd-header-account.is-open,
...
.gd-header-account {
  ...
  max-width: 146px;
  padding-right: 34px; }
  .gd-header-account:hover {
    background: rgba(255, 255, 255, 0.3); }
  .gd-header-account::after {
    content: "\e612";
    position: absolute;
    top: 0;
    right: 11px;
    ...
    font-size: 18px;
    font-weight: 700; }
  .gd-header-account.is-open::after {
    content: "\e613"; }
...
.gd-icon-header-help::before,
.gd-icon-header-help-back::before {
...
.hamburger-icon {
  ...
  .hamburger-icon.is-open {
    ...
    right: 0;
    margin: 0; }
    .hamburger-icon.is-open::before, .hamburger-icon.is-open::after {
      top: 21px;
      right: 9px;
      left: 9px;
      border-color: var(--gd-palette-complementary-6, inherit); }
    .hamburger-icon.is-open::before {
      transform: rotate(45deg); }
    .hamburger-icon.is-open::after {
      transform: rotate(-45deg); }
    .hamburger-icon.is-open i {
      right: 50%;
      left: 50%;
      opacity: 0;
      border-color: var(--gd-palette-complementary-6, inherit); }
...
.logout-button {
  ...
  height: 33px;
  margin: 0 15px;
  border: 1px solid rgba(176, 190, 202, 0.4);
  box-shadow: 0 1px 1px 0 var(--gd-shadow-color, rgba(20, 57, 93, 0.05));
  color: var(--gd-palette-complementary-0, #fff);
  cursor: pointer;
  transition: 0.2s;
  border-radius: 3px;
  ...
  .logout-button .gd-icon-logout {
    position: relative;
    top: 1px;
    margin-right: 5px;
    margin-left: -4px; }
  .logout-button .gd-button-text {
    position: relative;
    top: -1px; }
  .logout-button:hover {
    border-color: rgba(148, 161, 173, 0.4);
    background-color: var(--gd-palette-complementary-7, #6d7680); }
...
.gd-list-item.gd-project-list-item {
  ...
  font-weight: 400;
  padding: 0 15px; }
  .gd-list-item.gd-project-list-item .project-title {
    flex: 0 1 auto;
    overflow: hidden;
    text-overflow: ellipsis; }
  .gd-list-item.gd-project-list-item .demo-sticker {
    box-sizing: border-box;
    flex: 0 auto;
    height: 16px;
    padding: 2px 6px 1px;
    ...
    font-weight: bold;
    text-transform: uppercase; }
  .gd-list-item.gd-project-list-item.gd-is-selected {
    font-weight: bold; }

.gd-header-account-dropdown {
  overflow: hidden; }
  .gd-header-account-dropdown .gd-list {
    min-width: 210px; }
...
.gd-header-help-dropdown {
  overflow: hidden; }
  .gd-header-help-dropdown .gd-list {
    min-width: 150px; }
...
.gd-header-project-picker-footer {
  padding: 15px;
  border-top: 1px solid var(--gd-palette-complementary-3, #dde4eb); }
  .gd-header-project-picker-footer .gd-workspace-picker-home-footer {
    color: var(--gd-palette-complementary-8, #464e56);
    padding-left: 30px;
    text-decoration: none; }
    .gd-header-project-picker-footer .gd-workspace-picker-home-footer:hover {
      color: var(--gd-palette-complementary-9, #000);
      text-decoration: underline; }
    .gd-header-project-picker-footer .gd-workspace-picker-home-footer .gd-icon-home {
      position: absolute;
      margin-left: -30px; }
...
.gd-data-header-menu-section {
  display: flex;
  flex: 1 0 auto; }
  .gd-data-header-menu-section .gd-icon-sources {
    border-bottom-right-radius: 0;
    border-top-right-radius: 0; }
    ...
    .gd-data-header-menu-section .gd-icon-sources:hover {
      z-index: 100;
      box-shadow: 0 0 0 1px #14b2e2; }
      .gd-data-header-menu-section .gd-icon-sources:hover.disabled {
        color: var(--gd-palette-complementary-5, #b0beca); }
      .gd-data-header-menu-section .gd-icon-sources:hover.is-normal {
        color: var(--gd-palette-complementary-7, #6d7680); }
  .gd-data-header-menu-section .gd-icon-model {
    ...
    .gd-data-header-menu-section .gd-icon-model:hover {
      z-index: 100;
      box-shadow: 0 0 0 1px #14b2e2; }
      .gd-data-header-menu-section .gd-icon-model:hover.disabled {
        color: var(--gd-palette-complementary-5, #b0beca); }
      .gd-data-header-menu-section .gd-icon-model:hover.is-normal {
        color: var(--gd-palette-complementary-7, #6d7680); }
  .gd-data-header-menu-section .gd-icon-cloud-upload, .gd-data-header-menu-section .gd-icon-uploadcloud, .gd-data-header-menu-section .gd-icon-upload {
    border-bottom-left-radius: 0;
    border-top-left-radius: 0; }
    .gd-data-header-menu-section .gd-icon-cloud-upload::before, .gd-data-header-menu-section .gd-icon-uploadcloud::before, .gd-data-header-menu-section .gd-icon-upload::before {
      top: 11px; }
      .gd-data-header-menu-section .gd-icon-cloud-upload::before.disabled, .gd-data-header-menu-section .gd-icon-uploadcloud::before.disabled, .gd-data-header-menu-section .gd-icon-upload::before.disabled {
        color: var(--gd-palette-complementary-5, #b0beca); }
      .gd-data-header-menu-section .gd-icon-cloud-upload::before.disabled, .gd-data-header-menu-section .gd-icon-uploadcloud::before.disabled, .gd-data-header-menu-section .gd-icon-upload::before.disabled {
        color: var(--gd-palette-complementary-5, #b0beca); }
      .gd-data-header-menu-section .gd-icon-cloud-upload::before.is-normal, .gd-data-header-menu-section .gd-icon-uploadcloud::before.is-normal, .gd-data-header-menu-section .gd-icon-upload::before.is-normal {
        color: var(--gd-palette-complementary-7, #6d7680); }
    .gd-data-header-menu-section .gd-icon-cloud-upload:hover, .gd-data-header-menu-section .gd-icon-uploadcloud:hover, .gd-data-header-menu-section .gd-icon-upload:hover {
      z-index: 100;
      box-shadow: 0 0 0 1px #14b2e2; }
      .gd-data-header-menu-section .gd-icon-cloud-upload:hover.disabled, .gd-data-header-menu-section .gd-icon-uploadcloud:hover.disabled, .gd-data-header-menu-section .gd-icon-upload:hover.disabled {
        color: var(--gd-palette-complementary-5, #b0beca); }
      .gd-data-header-menu-section .gd-icon-cloud-upload:hover.is-normal, .gd-data-header-menu-section .gd-icon-uploadcloud:hover.is-normal, .gd-data-header-menu-section .gd-icon-upload:hover.is-normal {
        color: var(--gd-palette-complementary-7, #6d7680); }
    .gd-data-header-menu-section .gd-icon-cloud-upload.is-normal::before, .gd-data-header-menu-section .is-normal.gd-icon-uploadcloud::before, .gd-data-header-menu-section .is-normal.gd-icon-upload::before {
      color: var(--gd-palette-complementary-7, #6d7680); }
  ...
  .gd-data-header-menu-section button[class*="gd-button-"]::before {
    ...
    height: 16px;
    font-size: 16px; }
  .gd-data-header-menu-section .gd-button-primary[class*="gd-icon-"], .gd-data-header-menu-section .gd-button-link.gd-button-icon-only[class*="gd-icon-"], .gd-data-header-menu-section .gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"] {
    height: 27px;
    padding-left: 11px;
    padding-right: 11px; }
  .gd-data-header-menu-section button.is-active {
    ...
    .gd-data-header-menu-section button.is-active::before, .gd-data-header-menu-section button.is-active::after {
      top: calc(50% - 1px);
      color: #14b2e2; }
    .gd-data-header-menu-section button.is-active .gd-button-text {
      font-weight: bold; }
    .gd-data-header-menu-section button.is-active .gd-button-icon {
      margin-top: 2px; }
    .gd-data-header-menu-section button.is-active:focus {
      box-shadow: 0 0 3px 0 #14b2e2; }
  .gd-data-header-menu-section button.is-normal .gd-button-text {
    color: var(--gd-palette-complementary-7, #6d7680); }
  .gd-data-header-menu-section .gd-button-text {
    font-weight: normal;
    font-size: 12px;
    line-height: 14px; }
  .gd-data-header-menu-section,
  .gd-data-header-menu-section li {
    margin: 0;
    padding: 0; }
  .gd-data-header-menu-section li {
    display: block;
...
button.gd-button-primary.gd-icon-cloud-upload.s-load.gd-button > span, button.gd-button-primary.s-load.gd-button.gd-icon-uploadcloud > span, button.s-load.gd-button.gd-icon-uploadcloud.gd-button-link.gd-button-icon-only[class*="gd-icon-"] > span, button.s-load.gd-button.gd-icon-uploadcloud.gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"] > span, button.gd-button-primary.s-load.gd-button.gd-icon-upload > span, button.s-load.gd-button.gd-icon-upload.gd-button-link.gd-button-icon-only[class*="gd-icon-"] > span, button.s-load.gd-button.gd-icon-upload.gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"] > span, button.gd-icon-cloud-upload.s-load.gd-button.gd-button-link.gd-button-icon-only[class*="gd-icon-"] > span, button.gd-icon-cloud-upload.s-load.gd-button.gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"] > span, button.gd-button-primary.gd-icon-sources.s-sources.gd-button > span, button.gd-icon-sources.s-sources.gd-button.gd-button-link.gd-button-icon-only[class*="gd-icon-"] > span, button.gd-icon-sources.s-sources.gd-button.gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"] > span {
  margin-left: 23px; }

button.gd-button-primary.gd-icon-model.s-model.gd-button > span, button.gd-icon-model.s-model.gd-button.gd-button-link.gd-button-icon-only[class*="gd-icon-"] > span, button.gd-icon-model.s-model.gd-button.gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"] > span {
  margin-left: 22px; }

button.gd-button-primary.gd-upsell-button, button.gd-upsell-button.gd-button-link.gd-button-icon-only[class*="gd-icon-"], button.gd-upsell-button.gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"] {
  width: 93px;
  height: 27px;
  font-style: normal;
  font-weight: normal;
  ...
  background: #8351a4;
  font-family: gdcustomfont, avenir, "Helvetica Neue", arial, sans-serif; }
  button.gd-button-primary.gd-upsell-button .gd-upgrade-button-text, button.gd-upsell-button.gd-button-link.gd-button-icon-only[class*="gd-icon-"] .gd-upgrade-button-text, button.gd-upsell-button.gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"] .gd-upgrade-button-text {
    margin-right: 11px;
    font-size: 12px;
    font-family: gdcustomfont, avenir, "Helvetica Neue", arial, sans-serif; }
  button.gd-button-primary.gd-upsell-button .gd-icon-star, button.gd-upsell-button.gd-button-link.gd-button-icon-only[class*="gd-icon-"] .gd-icon-star, button.gd-upsell-button.gd-button-icon-only.gd-button-link-dimmed[class*="gd-icon-"] .gd-icon-star {
    width: 14px;
    height: 13px;
    margin: auto auto 6.5px 11px;
    background: url("~@gooddata/sdk-ui-kit/esm/assets/star.svg") no-repeat; }
  button.gd-button-primary.gd-upsell-button:hover, button.gd-upsell-button.gd-button-link.gd-button-icon-only:hover[class*="gd-icon-"], button.gd-upsell-button.gd-button-icon-only.gd-button-link-dimmed:hover[class*="gd-icon-"] {
    box-sizing: border-box;
    border: 1px solid rgba(0, 0, 0, 0.1);
    box-shadow: 0 1px 2px rgba(0, 0, 0, 0.15), inset 0 -2px 0 rgba(0, 0, 0, 0.15);
    color: #fff;
    background: linear-gradient(0deg, rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.1)), #8351a4; }
  button.gd-button-primary.gd-upsell-button:focus, button.gd-upsell-button.gd-button-link.gd-button-icon-only:focus[class*="gd-icon-"], button.gd-upsell-button.gd-button-icon-only.gd-button-link-dimmed:focus[class*="gd-icon-"] {
    box-sizing: border-box;
    border: 1px solid rgba(0, 0, 0, 0.2);
    box-shadow: 0 0 5px 2px rgba(131, 81, 164, 0.6), 0 1px 2px rgba(0, 0, 0, 0.15), inset 0 -2px 0 rgba(0, 0, 0, 0.15);
    color: #fff;
    background: #8351a4; }
  button.gd-button-primary.gd-upsell-button:active, button.gd-upsell-button.gd-button-link.gd-button-icon-only:active[class*="gd-icon-"], button.gd-upsell-button.gd-button-icon-only.gd-button-link-dimmed:active[class*="gd-icon-"] {
    box-sizing: border-box;
    border: 1px solid rgba(0, 0, 0, 0.1);
...
.gd-header-badge {
  ...
  font-size: 12px;
  font-weight: 400; }
  .gd-header-badge + .gd-header-badge {
    margin-left: 5px; }
...
.gd-message-support, .gd-message-dismiss {
  font: inherit;
  color: inherit;
  opacity: 0.85;
  cursor: pointer; }
  .gd-message-support:hover, .gd-message-dismiss:hover, .gd-message-support:focus, .gd-message-dismiss:focus, .gd-message-support:active, .gd-message-dismiss:active {
    color: inherit;
    opacity: 1; }
...
.gd-message {
  ...
  .gd-message a:not(.gd-message-dismiss) {
    ...
    text-decoration: underline; }
  .gd-message.progress {
    color: var(--gd-palette-info-base, var(--gd-palette-primary-base, #14b2e2));
    background: var(--gd-palette-info-base-t85, var(--gd-palette-primary-base-t85, rgba(20, 178, 226, 0.15))); }
  .gd-message.success {
    color: var(--gd-palette-success-base, #00c18d);
    background: var(--gd-palette-success-base-t85, rgba(0, 193, 141, 0.15)); }
  .gd-message.warning {
    color: var(--gd-palette-warning-base, #f18600);
    background: var(--gd-palette-warning-base-t85, rgba(250, 218, 35, 0.15)); }
...
.gd-message.intensive {
  color: var(--gd-palette-complementary-0, #fff);
  background: var(--gd-palette-error-base-t02, rgba(229, 77, 66, 0.98)); }
  .gd-message-overlay.success, .gd-message-overlay.progress, .gd-message-overlay.error,
  .gd-message.intensive.success,
  .gd-message.intensive.progress,
  .gd-message.intensive.error {
    color: var(--gd-palette-complementary-0, #fff); }
  .gd-message-overlay.success,
  .gd-message.intensive.success {
    background: var(--gd-palette-success-base-t02, rgba(0, 193, 141, 0.98)); }
  .gd-message-overlay.progress,
  .gd-message.intensive.progress {
    background: var(--gd-palette-info-base-t02, var(--gd-palette-primary-base-t02, rgba(20, 178, 226, 0.98))); }
  .gd-message-overlay.error,
  .gd-message.intensive.error {
    background: var(--gd-palette-error-base-t02, rgba(229, 77, 66, 0.98)); }
  .gd-message-overlay.warning,
  .gd-message.intensive.warning {
    color: var(--gd-palette-warning-text-dimmed, #6a6a4c);
    background: var(--gd-palette-warning-base, #fada23); }
...
.gd-message-overlay {
  ...
  -webkit-transition-timing-function: "ease-in-out";
  transition-timing-function: "ease-in-out";
  box-shadow: 0 1px 3px rgba(20, 56, 92, 0.1), 0 2px 9px rgba(20, 57, 93, 0.15); }
  .gd-message-overlay.is-hidden {
    opacity: 0; }
  .gd-message-overlay-custom {
    padding: 0;
    min-width: 620px;
    max-width: 350px; }
    @media only screen and (max-width: 640px) {
  ...
  .gd-message-overlay .gd-message-text {
    ...
    .gd-message-overlay .gd-message-text > div {
      -ms-flex: 1 1 auto;
      flex: 1 1 auto; }
    .gd-message-overlay .gd-message-text .gd-message-support,
    .gd-message-overlay .gd-message-text .gd-message-dismiss-container {
      -ms-flex: 1 0 auto;
      flex: 1 0 auto; }
    .gd-message-overlay .gd-message-text-showmore + .gd-message-dismiss-container {
      position: absolute;
      top: 5px;
      right: 5px; }
    .gd-message-overlay .gd-message-text-header {
      margin: 0;
      padding: 5px 10px; }
    .gd-message-overlay .gd-message-text-showmorelink {
      color: rgba(var(--gd-palette-complementary-0, #fff), 0.85);
      cursor: pointer;
      font-size: 13px;
      text-decoration: underline;
      padding-left: 5px; }
      .gd-message-overlay .gd-message-text-showmorelink.warning {
        color: rgba(var(--gd-palette-warning-text-dimmed, #6a6a4c), 1); }
    .gd-message-overlay .gd-message-text-content {
      padding: 5px 10px;
      color: rgba(var(--gd-palette-complementary-0, #fff), 0.85);
      font-size: 13px;
      border-top: 1px solid rgba(var(--gd-palette-complementary-0, #fff), 0.85); }
      ...
      .gd-message-overlay .gd-message-text-content.off {
        ...
        height: 0;
        padding: 0; }
      .gd-message-overlay .gd-message-text-content.warning {
        color: rgba(var(--gd-palette-warning-text-dimmed, #6a6a4c), 1);
        border-color: rgba(var(--gd-palette-warning-text-dimmed, #6a6a4c), 0.3); }
...
.gd-customizable-checkmark {
  position: absolute;
  display: block; }

.gd-loading-dots {
  overflow: hidden; }
  .gd-loading-dots-centered {
    min-width: 36px;
    position: absolute;
    top: 50%;
    left: 50%;
  ...
  .gd-loading-dots div {
    ...
    margin-right: 6px;
    border-radius: 100%;
    background-color: var(--gd-palette-complementary-6, #b0beca);
    animation: bouncedelay 1.4s infinite ease-in-out;
    animation-fill-mode: both; }
  .gd-loading-dots .gd-loading-dots-1 {
    animation-delay: -0.32s; }
  .gd-loading-dots .gd-loading-dots-2 {
...
.gd-mobile-dropdown-overlay {
  height: 100%;
  background-color: var(--gd-palette-complementary-0, #f8fafb); }
  ...
  .gd-mobile-dropdown-overlay .gd-mobile-dropdown-header .gd-header-project {
    ...
    color: var(--gd-palette-complementary-8, #000);
    padding-right: 30px;
    border-bottom: 1px solid var(--gd-palette-complementary-4, #c9d5e0); }
...
.gd-loading-spinner {
  ...
  .gd-loading-spinner.small,
  .gd-loading-spinner.small svg {
    width: 16px;
    height: 16px; }
  .gd-loading-spinner.large,
  .gd-loading-spinner.large svg {
    width: 32px;
    height: 32px; }
...
.gd-editable-label textarea, .gd-editable-label-overlay textarea {
  overflow: hidden;
  width: inherit;
  border: none;
  vertical-align: inherit;
...
.gd-editable-label {
  ...
  vertical-align: inherit;
  min-width: 5em; }
  .gd-editable-label:hover, .gd-editable-label:focus, .gd-editable-label:active {
    cursor: text;
    border-color: #b1c1d1; }
  .gd-editable-label.is-editing {
    border-color: #b1c1d1; }
    .gd-editable-label.is-editing::after {
      display: none; }
  .gd-editable-label textarea {
    display: block;
    padding: 0;
    line-height: inherit;
    font-size: inherit;
...
.gd-editable-label-overlay textarea {
  padding: 0 1px;
  /* needed for IE */
  text-align: center; }
...
.color-picker-cell {
  ...
  outline: none;
  cursor: pointer; }
  .color-picker-cell::before {
    content: "";
    display: block;
    width: 100%;
    padding-top: 100%; }
  .color-picker-cell:hover, .color-picker-cell:focus, .color-picker-cell:active {
    padding: 0;
    border: 1px solid var(--gd-palette-complementary-0, #fff);
    transform: scale(1.1); }
  .overlay .color-picker-row:first-child .color-picker-cell:first-child {
    border-top-left-radius: 3px; }
  .overlay .color-picker-row:first-child .color-picker-cell:last-child {
    border-top-right-radius: 3px; }
  .overlay .color-picker-row:first-child .color-picker-cell:hover, .overlay .color-picker-row:first-child .color-picker-cell:focus, .overlay .color-picker-row:first-child .color-picker-cell:active {
    border-radius: 0; }
...
.color-picker-control-wrapper {
  ...
  font-size: 12px; }
  .color-picker-control-wrapper,
  .color-picker-control-wrapper .gd-input-field {
    text-align: center; }
  .color-picker-control-wrapper p {
    margin: 5px 0 10px; }
...
.color-picker-preview {
  ...
  padding: 20px 0 10px;
  border-top: 1px solid var(--gd-palette-complementary-3, #dde4eb); }
  .color-picker-preview .color-value {
    width: 30px;
    height: 30px;
    margin: 0 auto 10px;
    border: 1px solid transparent;
    border-radius: 50%; }
  .color-picker-preview .color-picker-value-wrapper {
    width: 60px; }
...
.color-picker-buttons-wrapper {
  ...
  padding: 20px 0;
  border-top: 1px solid var(--gd-palette-complementary-3, #dde4eb); }
  .color-picker-buttons-wrapper .gd-button {
    flex: 1;
    max-width: 100px;
    text-align: center; }
...
.gd-icon-fact.gd-button-small::before, .gd-icon-fact.gd-button-link::before, .gd-icon-fact.gd-button-link-dimmed::before,
.gd-icon-measure.gd-button-small::before,
.gd-icon-measure.gd-button-link::before,
.gd-icon-measure.gd-button-link-dimmed::before {
  margin-top: -1px; }
...
.gd-icon-aggregation.gd-button-small::before, .gd-icon-aggregation.gd-button-link::before, .gd-icon-aggregation.gd-button-link-dimmed::before {
  margin-top: -1px; }
...
.gd-icon-metric.gd-button-small::before, .gd-icon-metric.gd-button-link::before, .gd-icon-metric.gd-button-link-dimmed::before {
  margin-top: -1px; }
...
.gd-icon-attribute.gd-button-small::before, .gd-icon-attribute.gd-button-link::before, .gd-icon-attribute.gd-button-link-dimmed::before {
  margin-top: -1px; }
...
.gd-icon-date.gd-button-link::before, .gd-icon-date.gd-button-link-dimmed::before {
  margin-top: -2px; }

.gd-icon-measure-value-filter::before, .gd-icon-all::before, .gd-icon-greater-than::before, .gd-icon-greater-than-equal-to::before, .gd-icon-less-than::before, .gd-icon-less-than-equal-to::before, .gd-icon-between::before, .gd-icon-not-between::before, .gd-icon-equal-to::before, .gd-icon-not-equal-to::before {
  width: 18px;
  height: 15px; }
...
.gd-icon-all.gd-button-link::before, .gd-icon-all.gd-button-link-dimmed::before {
  margin-top: -2px; }
...
.gd-icon-greater-than.gd-button-link::before, .gd-icon-greater-than.gd-button-link-dimmed::before {
  margin-top: -2px; }
...
.gd-icon-greater-than-equal-to.gd-button-link::before, .gd-icon-greater-than-equal-to.gd-button-link-dimmed::before {
  margin-top: -2px; }
...
.gd-icon-less-than.gd-button-link::before, .gd-icon-less-than.gd-button-link-dimmed::before {
  margin-top: -2px; }
...
.gd-icon-less-than-equal-to.gd-button-link::before, .gd-icon-less-than-equal-to.gd-button-link-dimmed::before {
  margin-top: -2px; }
...
.gd-icon-between.gd-button-link::before, .gd-icon-between.gd-button-link-dimmed::before {
  margin-top: -2px; }
...
.gd-icon-not-between.gd-button-link::before, .gd-icon-not-between.gd-button-link-dimmed::before {
  margin-top: -2px; }
...
.gd-icon-equal-to.gd-button-link::before, .gd-icon-equal-to.gd-button-link-dimmed::before {
  margin-top: -2px; }
...
.gd-icon-not-equal-to.gd-button-link::before, .gd-icon-not-equal-to.gd-button-link-dimmed::before {
  margin-top: -2px; }
...
.gd-share-dialog .gd-dialog-header {
  margin-bottom: 17px; }
  .gd-share-dialog .gd-dialog-header h3 {
    margin-top: 3px; }

.gd-share-dialog .input-checkbox-label {
  margin: 10px 0 0; }
...
.gd-share-dialog-grantee-content-header {
  ...
  .gd-share-dialog-grantee-content-header h3 {
    ...
    text-transform: uppercase;
    color: var(--gd-palette-complementary-6, #94a1ad); }
    .gd-share-dialog-grantee-content-header h3::after {
      content: "";
      position: absolute;
      top: 50%;
      display: inline-block;
      ...
      margin-left: 10px;
      border-top: 1px solid var(--gd-palette-complementary-3, #dde4eb); }
    .gd-share-dialog-grantee-content-header h3 + label {
      margin-top: 10px; }
...
.gd-share-dialog-grantee-item {
  ...
  height: 50px; }
  .gd-share-dialog-grantee-item .gd-grantee-content {
    display: flex;
    flex: 1;
    min-width: 0;
    flex-direction: column;
  ...
  .gd-share-dialog-grantee-item .gd-grantee-content-label-inactive {
    ...
    cursor: default;
    font-weight: bold; }
  .gd-share-dialog-grantee-item .gd-grantee-count-button {
    height: 20px; }
  .gd-share-dialog-grantee-item .gd-grantee-content-email {
    font-size: 14px;
    line-height: 1.3rem;
    font-weight: normal;
    color: var(--gd-palette-complementary-6, #94a1ad); }
  .gd-share-dialog-grantee-item .gd-grantee-content-inactive {
    font-size: 14px;
    line-height: 1.3rem;
    font-weight: normal;
    color: var(--gd-palette-complementary-6, #94a1ad); }
  .gd-share-dialog-grantee-item .gd-grantee-content-user-count {
    padding: 0;
    border: 0;
    line-height: 20px; }
  .gd-share-dialog-grantee-item .gd-grantee-item-icon {
    width: 32px;
    height: 32px;
    border-radius: 20px;
    font-size: 18px;
    ...
    text-align: center;
    background: var(--gd-palette-complementary-2, #ebeff4); }
  .gd-share-dialog-grantee-item .gd-grantee-item-icon-inactive {
    width: 32px;
    height: 32px;
    border-radius: 20px;
    font-size: 18px;
    border: 1px dashed var(--gd-palette-complementary-2, #ebeff4);
    line-height: 36px;
    text-align: center;
    border-style: dashed; }
  .gd-share-dialog-grantee-item .gd-grantee-item-icon-left {
    margin-right: 10px; }
  .gd-share-dialog-grantee-item .gd-grantee-item-icon-right {
    display: none;
    margin-left: 10px;
    cursor: pointer; }
  @media only screen and (max-width: 640px) {
    ...
    .gd-share-dialog-grantee-item .gd-grantee-item-icon {
      background: transparent; } }
  .gd-share-dialog-grantee-item .gd-grantee-item-icon-owner {
    display: block;
    font-size: 12px;
    width: auto;
    height: auto;
    ...
    color: var(--gd-palette-complementary-6, #94a1ad);
    cursor: default; }
  .gd-share-dialog-grantee-item .gd-grantee-icon-user::after {
    content: "\e602";
    position: relative;
    top: -3px;
    font-family: "Indigo", sans-serif;
    ...
    font-size: 14px;
    font-weight: 400; }
  .gd-share-dialog-grantee-item .gd-grantee-icon-group::after {
    content: "\e607";
    position: relative;
    top: -2px;
    font-family: "Indigo", sans-serif;
    ...
    font-size: 16px;
    font-weight: 400; }
  .gd-share-dialog-grantee-item .gd-grantee-icon-trash::after {
    content: "\e61a";
    position: relative;
    top: -3px;
    font-family: "Indigo", sans-serif;
    ...
    font-size: 14px;
    font-weight: 700; }
  .gd-share-dialog-grantee-item .gd-grantee-item-delete-owner {
    display: flex;
    align-items: center; }
  .gd-share-dialog-grantee-item .gd-grantee-item-delete {
    display: flex;
    align-items: center; }
  .gd-share-dialog-grantee-item .gd-grantee-item-icon-left-background {
    display: flex;
    align-items: center; }
  .gd-share-dialog-grantee-item .gd-grantee-item-delete:hover {
    background: var(--gd-palette-error-lightest, #fff2f1); }
    .gd-share-dialog-grantee-item .gd-grantee-item-delete:hover ~ .gd-grantee-content {
      background: var(--gd-palette-error-lightest, #fff2f1); }
    .gd-share-dialog-grantee-item .gd-grantee-item-delete:hover .gd-grantee-item-delete-background {
      background: var(--gd-palette-error-lightest, #fff2f1); }
    .gd-share-dialog-grantee-item .gd-grantee-item-delete:hover .gd-grantee-item-icon {
      background: var(--gd-palette-error-lightest, #fff2f1); }
    .gd-share-dialog-grantee-item .gd-grantee-item-delete:hover .gd-grantee-icon-trash::after {
      color: var(--gd-palette-error-base, #e54d42); }
    .gd-share-dialog-grantee-item .gd-grantee-item-delete:hover ~ .gd-grantee-item-icon-left-background {
      background: var(--gd-palette-error-lightest, #fff2f1); }
      .gd-share-dialog-grantee-item .gd-grantee-item-delete:hover ~ .gd-grantee-item-icon-left-background .gd-grantee-item-icon {
        background: var(--gd-palette-error-lightest, #fff2f1); }
  .gd-share-dialog-grantee-item:hover {
    background: var(--gd-palette-complementary-2, #ebeff4); }
    .gd-share-dialog-grantee-item:hover .gd-grantee-item-icon-right {
      display: block; }

.gd-share-dialog-content-select {
  margin-bottom: 15px; }
  .gd-share-dialog-content-select .gd-share-dialog__control {
    box-sizing: border-box;
    width: 100%;
    margin: 0;
    padding: 0;
    ...
    border-radius: 3px;
    min-height: 32px; }
    .gd-share-dialog-content-select .gd-share-dialog__control:hover {
      border-color: var(--gd-palette-complementary-5, #b3b3b3); }
  .gd-share-dialog-content-select .gd-share-dialog__control--is-focused,
  .gd-share-dialog-content-select .gd-share-dialog__control--is-focused:hover {
    border-color: var(--gd-palette-primary-base, #14b2e2);
    outline: 0;
    box-shadow: inset 0 1px 1px 0 rgba(31, 53, 74, 0.2); }
  .gd-share-dialog-content-select .gd-share-dialog-input {
    display: inline-flex;
    flex-grow: 1; }
    .gd-share-dialog-content-select .gd-share-dialog-input div {
      width: 100%; }
    .gd-share-dialog-content-select .gd-share-dialog-input .gd-share-dialog__input {
      margin: 0;
      padding: 0;
      max-height: 19px;
      color: var(--gd-palette-complementary-8, #464e56);
  ...
  .gd-share-dialog-content-select .gd-share-dialog__placeholder {
    color: var(--gd-palette-complementary-6, rgba(109, 118, 128, 0.75)); }
  .gd-share-dialog-content-select .gd-share-dialog__menu {
    padding: 0;
    border-width: 1px;
    border-style: solid;
    ...
    margin-top: -2px;
    outline: 0;
    box-shadow: 0 0 1px 0 rgba(31, 53, 74, 0.8) inset;
    color: var(--gd-palette-complementary-8, #464e56);
    background-color: var(--gd-palette-complementary-0, #fff); }
  .gd-share-dialog-content-select .gd-share-dialog__menu-list {
    padding-top: 0;
    padding-bottom: 0; }
    .gd-share-dialog-content-select .gd-share-dialog__menu-list .gd-share-dialog__option {
      padding: 7px 12px; }
    .gd-share-dialog-content-select .gd-share-dialog__menu-list .gd-share-dialog__option--is-focused {
      background: var(--gd-palette-complementary-2, #ebeff4); }
    .gd-share-dialog-content-select .gd-share-dialog__menu-list .option-content {
      overflow: hidden;
      white-space: nowrap;
      text-overflow: ellipsis;
      cursor: default; }
    .gd-share-dialog-content-select .gd-share-dialog__menu-list .option-email {
      color: var(--gd-palette-complementary-6, #94a1ad);
      cursor: default; }
  .gd-share-dialog-content-select .gd-share-dialog__group {
    padding-bottom: 0; }
  .gd-share-dialog-content-select .gd-share-dialog-option-error {
    display: flex;
    min-height: 38px;
    justify-content: center;
    align-items: center; }
  .gd-share-dialog-content-select .gd-share-dialog-option-error-content {
    flex-grow: 2;
    margin: 4px;
    padding: 4px;
    font-size: 14px;
    ...
    color: var(--gd-palette-error-base, #e54d42);
    background: var(--gd-palette-error-lightest, #fff2f1); }
  .gd-share-dialog-content-select .gd-share-dialog-loading-mask-container {
    display: flex;
    justify-content: center;
    align-items: center;
    height: 38px; }
...
.gd-share-dialog-select-group-heading {
  ...
  margin-left: 12px;
  margin-right: 12px; }
  .gd-share-dialog-select-group-heading h3 {
    flex-grow: 2;
    position: relative;
    overflow: hidden;
    font-size: 11px;
    text-transform: uppercase;
    color: var(--gd-palette-complementary-6, #94a1ad); }
    .gd-share-dialog-select-group-heading h3::after {
      content: "";
      position: absolute;
      top: 50%;
      display: inline-block;
...
.gd-gradient-wrapper .gd-gradient-top, .gd-gradient-wrapper .gd-gradient-bottom {
  content: "";
  position: absolute;
  z-index: 10;
  right: 0;
...
/* Basic scroll gradient definition
   ========================================================================== */
.gd-gradient-wrapper {
  position: relative;
  display: flex;
  ...
  width: 100%;
  min-height: 0; }
  .gd-gradient-wrapper .gd-gradient-top {
    top: 0; }
  .gd-gradient-wrapper .gd-gradient-bottom {
    bottom: 0; }
  .gd-gradient-wrapper .gd-gradient-content {
    display: flex;
    flex: 1 1 auto;
    overflow-y: auto;
    overflow-x: hidden;
    flex-direction: column; }
    .gd-gradient-wrapper .gd-gradient-content::before {
      content: "";
      width: 100%;
      height: 0;
      flex-grow: 1;
...
.sort-attribute-section .gd-icon-sort-numerical-asc::before,
.gd-attribute-sorting-dropdown-body .gd-icon-sort-numerical-asc::before, .sort-attribute-section .gd-icon-sort-numerical-desc::before,
.gd-attribute-sorting-dropdown-body .gd-icon-sort-numerical-desc::before, .sort-attribute-section .gd-icon-sort-alphabetical-asc::before,
.gd-attribute-sorting-dropdown-body .gd-icon-sort-alphabetical-asc::before, .sort-attribute-section .gd-icon-sort-alphabetical-desc::before,
...
.gd-sort-charting-dropdown {
  ...
  flex-direction: column;
  height: inherit; }
  .gd-sort-charting-dropdown.gd-sort-charting-dropdown-wide {
    width: 250px; }
  .gd-sort-charting-dropdown .gd-sort-charting-dropdown-header {
    flex: 0 0 auto;
    padding: 10px;
    background-color: var(--gd-palette-complementary-2, #ebeff4);
    border-bottom: 1px solid var(--gd-palette-complementary-3, #dde4eb); }
    .gd-sort-charting-dropdown .gd-sort-charting-dropdown-header > div {
      color: var(--gd-palette-complementary-7, #6d7680);
      font-size: 12px;
      text-transform: uppercase; }
  .gd-sort-charting-dropdown .sort-attribute-section {
    margin-bottom: 10px; }
    .gd-sort-charting-dropdown .sort-attribute-section .sort-attribute-item:not(:first-child) {
      margin-top: 10px; }
  .gd-sort-charting-dropdown .section {
    padding: 10px; }
  .gd-sort-charting-dropdown .gd-sort-charting-dropdown {
    padding: 8px;
    border-top-left-radius: 3px;
    border-top-right-radius: 3px;
    font-size: 12px;
    color: var(--gd-palette-complementary-7, #6d7680); }
    .gd-sort-charting-dropdown .gd-sort-charting-dropdown button {
      width: 100%; }
  .gd-sort-charting-dropdown .chart-sorting-dropdown-footer {
    margin: 0 10px;
    padding: 10px 0;
    border-top: 1px solid var(--gd-palette-complementary-3, #dde4eb);
    text-align: right; }
    .gd-sort-charting-dropdown .chart-sorting-dropdown-footer button + button {
      margin-left: 10px; }
  .gd-sort-charting-dropdown .sort-measure-section {
    display: flex;
    align-items: center;
    margin: 8px 0 10px 6px;
    white-space: nowrap;
    border-left: 2px dashed rgba(176, 190, 202, 0.45); }
    .gd-sort-charting-dropdown .sort-measure-section .select-label {
      flex: 0 0 auto;
      margin-right: 10px;
      margin-left: 10px; }
    .gd-sort-charting-dropdown .sort-measure-section .measure-sorting-dropdown {
      flex: 1 1 auto;
      overflow: hidden; }
...
.gd-sorting-measure {
  width: 100%;
  overflow-x: auto; }
  .gd-sorting-measure.gd-button-link, .gd-sorting-measure.gd-button-link-dimmed {
    display: flex;
    width: 100%;
    text-align: left;
    font-size: 12px;
    color: var(--gd-palette-complementary-8, #464e56); }
  .gd-sorting-measure .gd-sorting-measure-title {
    flex-grow: 1; }
  .gd-sorting-measure .gd-sorting-sequence-number {
    flex-grow: 0;
    flex-shrink: 0;
    font-size: 10px;
    line-height: 10px;
...
.gd-attribute-sorting-dropdown-body .gd-icon-sort-numerical-asc::before {
  background-image: url("~@gooddata/sdk-ui-kit/styles/icons/icon-0-9.svg"); }

.sort-attribute-section .gd-icon-sort-numerical-desc::before,
.gd-attribute-sorting-dropdown-body .gd-icon-sort-numerical-desc::before {
  background-image: url("~@gooddata/sdk-ui-kit/styles/icons/icon-9-0.svg"); }

.sort-attribute-section .gd-icon-sort-alphabetical-asc::before,
.gd-attribute-sorting-dropdown-body .gd-icon-sort-alphabetical-asc::before {
  background-image: url("~@gooddata/sdk-ui-kit/styles/icons/icon-a-z.svg"); }

.sort-attribute-section .gd-icon-sort-alphabetical-desc::before,
.gd-attribute-sorting-dropdown-body .gd-icon-sort-alphabetical-desc::before {
  background-image: url("~@gooddata/sdk-ui-kit/styles/icons/icon-z-a.svg"); }
