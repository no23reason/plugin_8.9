 ...
 * @internal
 */
export declare type GranteeItem = IGranteeUser | IGranteeInactiveOwner | IGranteeGroup | IGranteeGroupAll;
/**
 * @internal
 */
export declare type GranteeType = "user" | "inactive_owner" | "group" | "groupAll";
/**
 * @internal
 */
 ...
 * @internal
 */
export declare const isGranteeGroupAll: (obj: unknown) => obj is IGranteeGroup;
/**
 * @internal
 */
