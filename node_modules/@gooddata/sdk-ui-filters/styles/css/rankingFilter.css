...
.gd-rf-operator-dropdown-body {
  width: 100px; }
  .gd-rf-operator-dropdown-body .gd-button-link {
    width: 100%;
    text-align: left;
    font-size: 12px;
    color: var(--gd-palette-complementary-8, #464e56); }
  .gd-rf-operator-dropdown-body .gd-button-link.is-selected {
    color: var(--gd-palette-primary-base, #14b2e2); }
...
.gd-rf-attribute-dropdown-body {
  ...
  max-height: 300px;
  overflow-x: auto; }
  .gd-rf-attribute-dropdown-body .gd-button-link {
    width: 100%;
    text-align: left;
    font-size: 12px;
    color: var(--gd-palette-complementary-8, #464e56); }
  .gd-rf-attribute-dropdown-body .gd-button-link.is-selected {
    color: var(--gd-palette-primary-base, #14b2e2); }
  .gd-rf-attribute-dropdown-body .gd-rf-attribute-all-records-icon {
    padding: 0 1px;
    color: var(--gd-palette-complementary-8, #464e56); }
  .gd-rf-attribute-dropdown-body .gd-button-link.disabled {
    color: var(--gd-palette-complementary-8, #464e56); }
  .gd-rf-attribute-dropdown-body .gd-button-link.disabled:hover {
...
.gd-rf-measure-dropdown-body {
  ...
  max-height: 300px;
  overflow-x: auto; }
  .gd-rf-measure-dropdown-body .gd-button-link {
    display: flex;
    width: 100%;
    text-align: left;
    font-size: 12px;
    color: var(--gd-palette-complementary-8, #464e56); }
  .gd-rf-measure-dropdown-body .gd-button-link.is-selected {
    color: var(--gd-palette-primary-base, #14b2e2); }
