...
.button-subtitle {
  ...
  .button-subtitle:only-child::after {
    display: inline-block; }
  .drag-preview .button-title::after, .drag-preview
  .button-subtitle::after {
    display: none; }
...
.gd-rf-dropdown-body {
  width: 250px;
  margin-top: 2px; }
  .gd-rf-dropdown-body .gd-rf-value-section {
    display: flex;
    align-items: center; }
    .gd-rf-dropdown-body .gd-rf-value-section .gd-rf-value-tooltip-icon {
      padding: 0 1px;
      color: var(--gd-palette-complementary-5, #b0beca); }
  .gd-rf-dropdown-body .gd-rf-dropdown-header {
    padding: 6px 6px 6px 10px;
    color: var(--gd-palette-complementary-6, #94a1ad);
    background: var(--gd-palette-complementary-2, #ebeff4);
    font-size: 12px;
    text-transform: uppercase; }
  .gd-rf-dropdown-body .gd-rf-dropdown-section {
    padding: 10px; }
    .gd-rf-dropdown-body .gd-rf-dropdown-section .gd-rf-dropdown-section-title {
      padding-top: 10px;
      font-size: 12px; }
    .gd-rf-dropdown-body .gd-rf-dropdown-section .gd-rf-preview {
      font-size: 12px;
      line-height: 16px; }
  .gd-rf-dropdown-body .gd-rf-dropdown-footer {
    margin: 0 10px;
    padding: 10px 0;
    border-top: 1px solid var(--gd-palette-complementary-3, #dde4eb);
    text-align: right; }
...
.gd-rf-operator-dropdown-body {
  width: 100px; }
  .gd-rf-operator-dropdown-body .gd-button-link, .gd-rf-operator-dropdown-body .gd-button-link-dimmed {
    width: 100%;
    text-align: left;
    font-size: 12px;
    color: var(--gd-palette-complementary-8, #464e56); }
  .gd-rf-operator-dropdown-body .gd-button-link.is-selected, .gd-rf-operator-dropdown-body .is-selected.gd-button-link-dimmed {
    color: var(--gd-palette-primary-base, #14b2e2); }

.gd-rf-value-dropdown-button {
  position: static;
  display: inline-block;
  width: 80px;
  margin: 0 10px; }
  .gd-rf-value-dropdown-button .gd-input-field {
    height: 27px;
    font-size: 12px;
    border-radius: 3px; }
  .gd-rf-value-dropdown-button .List {
    min-height: 32px; }
  .gd-rf-value-dropdown-button .gd-select-menu {
    padding: 0; }
  .gd-rf-value-dropdown-button .gd-select-heading {
    position: relative !important; }

.gd-rf-attribute-dropdown-button {
  width: 100%; }
  .gd-rf-attribute-dropdown-button .gd-button-icon {
    width: 18px;
    margin-right: 7px; }

.gd-rf-attribute-dropdown-body {
  width: 230px;
  max-height: 300px;
  overflow-x: auto; }
  .gd-rf-attribute-dropdown-body .gd-button-link, .gd-rf-attribute-dropdown-body .gd-button-link-dimmed {
    width: 100%;
    text-align: left;
    font-size: 12px;
    color: var(--gd-palette-complementary-8, #464e56); }
  .gd-rf-attribute-dropdown-body .gd-button-link.is-selected, .gd-rf-attribute-dropdown-body .is-selected.gd-button-link-dimmed {
    color: var(--gd-palette-primary-base, #14b2e2); }
  .gd-rf-attribute-dropdown-body .gd-rf-attribute-all-records-icon {
    padding: 0 1px;
    color: var(--gd-palette-complementary-8, #464e56); }
  .gd-rf-attribute-dropdown-body .gd-button-link.disabled, .gd-rf-attribute-dropdown-body .disabled.gd-button-link-dimmed {
    color: var(--gd-palette-complementary-8, #464e56); }
  .gd-rf-attribute-dropdown-body .gd-button-link.disabled:hover, .gd-rf-attribute-dropdown-body .disabled.gd-button-link-dimmed:hover {
    background-color: var(--gd-palette-complementary-2, #ebeff4);
    color: var(--gd-palette-complementary-8, #464e56); }

.gd-rf-attribute-dropdown-separator {
  border-top: 1px solid var(--gd-palette-complementary-3, #dde4eb); }

.gd-rf-measure-dropdown-button {
  width: 100%; }

.gd-rf-measure-dropdown-body {
  width: 230px;
  max-height: 300px;
  overflow-x: auto; }
  .gd-rf-measure-dropdown-body .gd-button-link, .gd-rf-measure-dropdown-body .gd-button-link-dimmed {
    display: flex;
    width: 100%;
    text-align: left;
    font-size: 12px;
    color: var(--gd-palette-complementary-8, #464e56); }
  .gd-rf-measure-dropdown-body .gd-button-link.is-selected, .gd-rf-measure-dropdown-body .is-selected.gd-button-link-dimmed {
    color: var(--gd-palette-primary-base, #14b2e2); }
  .gd-rf-measure-dropdown-body .gd-rf-measure-title {
    flex-grow: 1; }
  .gd-rf-measure-dropdown-body .gd-rf-sequence-number {
    flex-grow: 0;
    flex-shrink: 0;
    font-size: 10px;
    line-height: 10px;
...
.gd-rf-tooltip-bubble.gd-bubble {
  max-width: 200px; }
