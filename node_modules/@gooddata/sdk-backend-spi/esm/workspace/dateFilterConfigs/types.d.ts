 ...
 * @alpha
 */
export declare type AbsoluteFormType = "absoluteForm";
/**
 * Type that identifies the relative date filter form
 * @alpha
 */
export declare type RelativeFormType = "relativeForm";
/**
 * Type that identifies the absolute date filter preset
 * @alpha
 */
export declare type AbsolutePresetType = "absolutePreset";
/**
 * Type that identifies the relative date filter preset
 * @alpha
 */
export declare type RelativePresetType = "relativePreset";
/**
 * Type that identifies the date filter option
 * @alpha
 */
export declare type OptionType = AllTimeType | AbsoluteFormType | RelativeFormType | AbsolutePresetType | RelativePresetType;
/**
 ...
 * @alpha
 */
export declare type DateFilterGranularity = "GDC.time.date" | "GDC.time.week_us" | "GDC.time.month" | "GDC.time.quarter" | "GDC.time.year";
/**
