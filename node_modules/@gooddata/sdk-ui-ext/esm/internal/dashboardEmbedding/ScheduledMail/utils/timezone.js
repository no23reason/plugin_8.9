...
var TIMEZONE_BY_OFFSETS = timezones.find(function (tz) {
    return tz.januaryOffset === JANUARY_OFFSET && tz.juneOffset === JUNE_OFFSET;
});
var TIMEZONE_DEFAULT = timezones.find(function (tz) {
    return tz.identifier === "Etc/UTC";
});
