...
export declare function getGeoPushpinWidgetStyle(visType: VisType, visualizationItemWidth: number, currentColumnWidth: number, windowHeight: number, enableCustomHeight: boolean): React.CSSProperties;
