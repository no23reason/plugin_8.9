import { IDashboardLayoutSectionHeader, IDashboardLayoutSize, IDashboardLayout, IDashboardLayoutSection } from "@gooddata/sdk-backend-spi";
...
export declare class DashboardLayoutSectionBuilder<TContent> implements IDashboardLayoutSectionBuilder<TContent> {
    ...
    addItem(xlSize: IDashboardLayoutSize, create?: (builder: IDashboardLayoutItemBuilder<TContent>) => IDashboardLayoutItemBuilder<TContent>, index?: number): this;
