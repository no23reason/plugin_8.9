import { IUserWorkspaceSettings, IWidgetAlertDefinition, IKpiWidgetDefinition } from "@gooddata/sdk-backend-spi";
...
export declare class DashboardItemWithKpiAlert extends Component<IDashboardItemWithKpiAlertProps, IDashboardItemWithKpiAlertState> {
    static defaultProps: Pick<IDashboardItemWithKpiAlertProps, "isAlertHighlighted" | "filters" | "alertDeletingStatus" | "alertSavingStatus" | "alertUpdatingStatus" | "suppressAlertTriggered" | "isReadOnlyMode">;
    private timeouts;
...
export {};
//# sourceMappingURL=DashboardItemWithKpiAlert.d.ts.map