...
import { IAnalyticalBackend, ITheme, IDashboard, IWidgetAlert, IScheduledMailDefinition, IScheduledMail, IWidget, FilterContextItem, ILegacyKpi } from "@gooddata/sdk-backend-spi";
...
import { IDashboardLayoutBuilder, IDashboardFilter, OnFiredDashboardViewDrillEvent, IDashboardViewConfig } from "../internal";
export { IDashboardLayoutBuilder, IDashboardLayoutSectionBuilder, DashboardLayoutSectionModifications, DashboardLayoutSectionsSelector, DashboardLayoutModifications, DashboardLayoutItemsSelector, DashboardLayoutItemModifications, IDashboardLayoutItemBuilder, IDashboardLayoutFacade, IDashboardLayoutItemFacade, IDashboardLayoutItemsFacade, IDashboardLayoutSectionFacade, IDashboardLayoutSectionsFacade, IDashboardFilter, OnFiredDashboardViewDrillEvent, IDashboardDrillEvent, IDashboardViewConfig, } from "../internal";
/**
 * @beta
 ...
 * @deprecated Will be removed in the 8.10.0 release. Superseded by Dashboard component; please see `@gooddata/sdk-ui-dashboard` and GoodData.UI documentation for v8.7
 */
export declare type DashboardLayoutTransform<TContent = any> = (layoutBuilder: IDashboardLayoutBuilder<TContent>, additionalProps: IDashboardLayoutTransformAdditionalProps) => IDashboardLayoutBuilder<TContent>;
/**
 * @beta
 * @deprecated Will be removed in the 8.10.0 release. Superseded by Dashboard component; please see `@gooddata/sdk-ui-dashboard` and GoodData.UI documentation for v8.7
 */
 ...
 * @deprecated Will be removed in the 8.10.0 release. Superseded by Dashboard component; please see `@gooddata/sdk-ui-dashboard` and GoodData.UI documentation for v8.7
 */
export declare type IDashboardWidgetRenderProps = {
    /**
 ...
 * @deprecated Will be removed in the 8.10.0 release. Superseded by Dashboard component; please see `@gooddata/sdk-ui-dashboard` and GoodData.UI documentation for v8.7
 */
export declare type IDashboardWidgetRenderer = (renderProps: IDashboardWidgetRenderProps) => JSX.Element;
/**
