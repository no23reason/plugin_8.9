import { IDashboardLayoutSize, ScreenSize, IDashboardLayoutItem, IDashboardLayout, AnalyticalWidgetType, ISettings, ILegacyKpi } from "@gooddata/sdk-backend-spi";
 ...
 * @internal
 */
declare type ItemPosition = [number, number];
/**
 *
 * @internal
 */
 ...
 * @internal
 */
export declare type MeasurableWidgetContent = IInsightDefinition | ILegacyKpi;
