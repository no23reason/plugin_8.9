...
var JUNE_OFFSET = -new Date(2011, 5, 1, 0, 0, 0, 0).getTimezoneOffset();
var timezonesRaw = [
...
var timezones = timezonesRaw.map(function (t) { return ({
    identifier: t[0],
    title: t[1],
    januaryOffset: t[2],
    juneOffset: t[3],
}); });
var TIMEZONE_BY_OFFSETS = timezones.find(function (tz) { return tz.januaryOffset === JANUARY_OFFSET && tz.juneOffset === JUNE_OFFSET; });
var TIMEZONE_DEFAULT = timezones.find(function (tz) { return tz.identifier === "Etc/UTC"; });
