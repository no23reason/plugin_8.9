...
var KpiAlertDialog = /** @class */ (function (_super) {
    ...
    function KpiAlertDialog(props) {
        ...
        _this.onChange = function (value) {
            _this.setState({ threshold: value });
        };
    ...
    KpiAlertDialog.prototype.formatMessage = function (id, options) {
        return this.props.intl.formatMessage({ id: id }, options);
    };
    ...
    KpiAlertDialog.prototype.renderDeleteLink = function () {
        if (this.props.alert) {
            var isDeleting = this.props.alertDeletingStatus === "inProgress";
    ...
    KpiAlertDialog.prototype.renderUpdateButton = function () {
        if (this.props.alert) {
            var isUpdating = this.props.alertUpdatingStatus === "inProgress";
            ...
            return (React.createElement(Button, { key: "update-button", className: "s-update-button gd-button-action save-button", value: updateButtonTitle, onClick: this.props.onAlertDialogUpdateClick, disabled: isUpdating }));
        }
        return false;
    };
    ...
    KpiAlertDialog.prototype.renderDialogContent = function () {
        var _a;
        var _b = this.props, isAlertDialogOpening = _b.isAlertDialogOpening, isAlertLoading = _b.isAlertLoading, isKpiFormatLoading = _b.isKpiFormatLoading;
        ...
        if ((_a = this.props.brokenAlertFilters) === null || _a === void 0 ? void 0 : _a.length) {
        ...
        var emailMe = (React.createElement("span", { className: "underline-dotted", title: this.props.userEmail },
        ...
        return (React.createElement("div", { className: "kpi-alert-dialog-content" },
            ...
            React.createElement(KpiAlertDialogWhenTriggeredPicker, { whenTriggered: this.state.alertType, intl: this.props.intl, onWhenTriggeredChange: this.onSelect }),
            React.createElement("div", { className: "input-container" },
                React.createElement(Input, { className: "s-threshold-input", hasError: hasError, isSmall: true, maxlength: 16, onChange: 
                    // TODO: type the Input so that it has string value for "text" and similar types
                    this.onChange, onEscKeyPress: this.closeDialog, onEnterKeyPress: this.saveKpiAlert, placeholder: this.props.thresholdPlaceholder, ref: this.threshold, suffix: inputSuffix, value: threshold })),
            ...
            React.createElement("div", { className: "buttons" },
                ...
                React.createElement(Button, { className: "gd-button-secondary cancel-button s-cancel_button", value: this.formatMessage("cancel"), onClick: this.onCancelClick }),
                this.renderDeleteLink())));
    };
    ...
    KpiAlertDialog.prototype.renderFiltersMessage = function () {
        var emailInfo = this.formatMessage("kpiAlertDialog.emailInfo", {
    ...
    KpiAlertDialog.prototype.focusThresholdInput = function () {
        ...
        setTimeout(function () {
            if (_this.threshold &&
                _this.threshold.current &&
                _this.threshold.current.inputNodeRef &&
                _this.threshold.current.inputNodeRef.inputNodeRef) {
