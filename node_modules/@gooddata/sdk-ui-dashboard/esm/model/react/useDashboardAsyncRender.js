 ...
 * @returns callbacks
 */
export var useDashboardAsyncRender = function (id) {
    var requestDashboardAsyncRender = useDispatchDashboardCommand(requestAsyncRender);
    var resolveDashboardAsyncRender = useDispatchDashboardCommand(resolveAsyncRender);
    var onRequestAsyncRender = useCallback(function () {
        requestDashboardAsyncRender(id);
    }, [id]);
    var onResolveAsyncRender = useCallback(function () {
        resolveDashboardAsyncRender(id);
    }, [id]);
    return {
        onRequestAsyncRender: onRequestAsyncRender,
        onResolveAsyncRender: onResolveAsyncRender,
    };
};
