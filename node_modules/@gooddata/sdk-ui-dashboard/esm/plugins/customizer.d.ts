import { CustomDashboardInsightComponent, CustomDashboardWidgetComponent, InsightComponentProvider, KpiComponentProvider, OptionalInsightComponentProvider, OptionalKpiComponentProvider } from "../presentation";
import { DashboardDispatch, DashboardEventHandler, DashboardEventHandlerFn, DashboardEvents, DashboardEventType, DashboardState, ExtendedDashboardWidget, ICustomDashboardEvent, ICustomWidget } from "../model";
