 ...
 * @internal
 */
export var isNonExportableError = typesUtils.combineGuards(isUnknownSdkError, isBadRequest, isNoDataSdkError, isProtectedReport, isDataTooLargeToCompute, isEmptyAfm);
/**
 * @internal
 */
export var isDataError = typesUtils.combineGuards(isUnknownSdkError, isBadRequest, isNoDataSdkError, isDataTooLargeToCompute, isDataTooLargeToDisplay, isProtectedReport, isEmptyAfm, isNegativeValues);
