...
.attribute-filter-button:active::after,
.edit-mode-on .attribute-filter-button:active::after, .attribute-filter-button.is-active::after,
.edit-mode-on .attribute-filter-button.is-active::after {
  box-shadow: inset 0 1px 0 0 var(--gd-shadow-color, rgba(177, 193, 209, 0.65));
  border-color: var(--gd-palette-complementary-5, var(--gd-palette-complementary-4, rgba(31, 52, 73, 0.2)));
  background: var(--gd-palette-complementary-2, #ecf0f5);
  /* Old browsers */
  background-image: -webkit-linear-gradient(top, var(--gd-palette-complementary-2, #dee6ef), var(--gd-palette-complementary-2, #ecf0f5));
  /* Chrome 10+, Saf5.1+ */
...
.drag-preview .button-title::after, .drag-preview .button-subtitle::after {
  display: none; }
...
.attributevalues-list .gd-list-item:hover .input-label-text {
  color: var(--gd-palette-complementary-9, inherit); }
...
@media only screen and (max-width: 320px), only screen and (max-width: 640px) {
  .gd-attribute-filter-dropdown-items-filtered .gd-filtered-message {
    font-size: 14px;
    background: var(--gd-palette-complementary-0, #f8fafb); } }
...
.drag-preview .gd-date-filter-button::after {
  background: var(--gd-palette-complementary-0, rgba(255, 255, 255, 0.95)); }
...
.drag-preview .gd-date-filter-button .button-title::after, .drag-preview .gd-date-filter-button .button-subtitle::after {
  display: none; }
...
.gd-date-filter-form-wrapper-inner {
  padding: 10px;
  background-color: var(--gd-palette-complementary-1, #f5f7f9); }
...
.gd-date-range-picker-picker .DayPicker-Day--selected:not(.DayPicker-Day--start):not(.DayPicker-Day--end) {
  color: var(--gd-palette-complementary-8, #464e56);
  background: var(--gd-palette-primary-lightest, #dff5fc); }
...
.gd-date-range-picker-error-message {
  ...
  border-radius: 3px;
  color: #888;
  background-color: var(--gd-palette-warning-base, #fada23); }
...
.gd-extended-date-filter-body .gd-date-filter-item-mobile.gd-list-item-header, .gd-extended-date-filter-body .gd-date-filter-item-mobile.gd-list-item-header:hover, .gd-extended-date-filter-body .gd-date-filter-item-mobile.gd-list-item-header:active {
  background-color: var(--gd-palette-complementary-2, rgba(221, 228, 235, 0.2)); }
...
.gd-extended-date-filter-body .gd-filter-list-item .gd-list-item-tooltip {
  color: var(--gd-palette-complementary-8, initial); }

.gd-extended-date-filter-body .gd-filter-list-item:hover .gd-list-item-tooltip {
  color: var(--gd-palette-complementary-9, initial); }
...
.kpi-link {
  ...
  .kpi-link:hover, .kpi-link:focus, .kpi-link:active {
    text-decoration: none; }
  .kpi-link:hover {
    color: var(--gd-dashboards-content-kpiWidget-kpi-primaryMeasureColor, var(--gd-palette-complementary-8, #464e56));
    opacity: 0.6; }
  .kpi-link:focus .kpi-value {
    color: var(--gd-dashboards-content-kpiWidget-kpi-primaryMeasureColor, var(--gd-palette-complementary-7, #6d7680)); }
  ...
  .kpi-link .kpi-value .kpi-link-style-underline::after {
    border-bottom: 2px solid var(--gd-dashboards-content-kpiWidget-kpi-primaryMeasureColor, var(--gd-palette-complementary-9, #6d7680)); }
...
.kpi-value {
  ...
  white-space: nowrap;
  vertical-align: bottom;
  color: var(--gd-dashboards-content-kpiWidget-kpi-primaryMeasureColor, var(--gd-palette-complementary-9, #000)); }
...
.kpi-alert-dialog {
  ...
  z-index: 1000;
  min-height: 148px;
  border: 1px solid var(--gd-palette-complementary-3, rgba(201, 213, 224, 0.5));
  border-radius: 5px;
  box-shadow: 0 1px 3px 0 var(--gd-shadow-color, rgba(20, 56, 93, 0.09)), 0 2px 9px 0 var(--gd-shadow-color, rgba(20, 56, 93, 0.15));
  background: var(--gd-palette-complementary-2, #ebeff4); }
...
.target-cc.self-cl .kpi-alert-dialog::before,
.target-tc.self-cl .kpi-alert-dialog::before {
  border-right-color: var(--gd-palette-complementary-3, rgba(201, 213, 224, 0.5)); }
...
.target-cc.self-cr .kpi-alert-dialog::before,
.target-tc.self-cr .kpi-alert-dialog::before {
  border-left-color: var(--gd-palette-complementary-3, rgba(201, 213, 224, 0.5)); }
...
.target-cl.self-tl .kpi-alert-dialog::before,
.target-cr.self-tr .kpi-alert-dialog::before {
  border-bottom-color: var(--gd-palette-complementary-3, rgba(201, 213, 224, 0.5)); }
...
.target-tl.self-bl .kpi-alert-dialog::before,
.target-tr.self-br .kpi-alert-dialog::before {
  border-top-color: var(--gd-palette-complementary-3, rgba(201, 213, 224, 0.5)); }
...
.kpi-alert-dialog-text {
  ...
  .kpi-alert-dialog-text + .email-info {
    padding-top: 15px;
    border-top: 1px solid var(--gd-palette-complementary-3, #dde4eb);
    color: var(--gd-palette-complementary-8, #6d7680); }
  @media only screen and (max-width: 320px), only screen and (max-width: 640px) {
...
.gd-dialog.gd-schedule-email-dialog {
  ...
  max-width: 620px; }
  .gd-dialog.gd-schedule-email-dialog .hr {
    height: 0;
    margin: 12px 0 14px;
    border-top: 1px solid var(--gd-palette-complementary-3, #dde4eb); }
...
.gd-textarea-component .gd-input-component-indicator {
  position: absolute;
  top: 10px;
  right: 10px;
  color: var(--gd-palette-complementary-8, #464e56);
...
.gd-textarea-component-collapsed .gd-input-field {
  overflow: hidden; }
...
.gd-attachment-component .gd-icon-pdf {
  position: relative;
  top: 1px;
  flex: 0;
  padding: 0;
...
.gd-schedule-email-dialog-repeat {
  ...
  flex-direction: column; }
  @media only screen and (max-width: 640px) {
    .gd-schedule-email-dialog-datetime .gd-label,
    .gd-schedule-email-dialog-repeat .gd-label {
      margin-bottom: 0; } }
  .gd-schedule-email-dialog-datetime > div,
  .gd-schedule-email-dialog-repeat > div {
    display: flex;
    align-items: center;
    flex-wrap: wrap; }

.gd-schedule-email-dialog-datetime > div .gd-datepicker {
  width: 119px; }
  @media only screen and (max-width: 640px) {
    .gd-schedule-email-dialog-datetime > div .gd-datepicker {
      width: calc((100vw - 20px - 20px - 20px - 20px) / 2); } }
  .gd-schedule-email-dialog-datetime > div .gd-datepicker .input-text {
    color: var(--gd-palette-complementary-7, #778491);
    font-size: 12px; }
  .gd-schedule-email-dialog-datetime > div .gd-datepicker .input-text:hover {
    color: var(--gd-palette-complementary-8, inherit); }
  .gd-schedule-email-dialog-datetime > div .gd-datepicker .gd-datepicker-icon {
    top: -2px; }

.gd-schedule-email-dialog-datetime > div .gd-schedule-email-dialog-datetime-time {
  margin-left: 20px; }

@media only screen and (max-width: 640px) {
  .gd-schedule-email-dialog-datetime > div .gd-schedule-email-dialog-datetime-timezone {
    width: 100%;
    margin-top: 15px; } }
...
@media only screen and (max-width: 640px) {
  .gd-schedule-email-dialog-repeat .gd-schedule-email-dialog-repeat-type {
    width: 100%;
    margin-bottom: 10px; }
    .gd-schedule-email-dialog-repeat .gd-schedule-email-dialog-repeat-type .button-dropdown {
      width: 100%; } }

.gd-schedule-email-dialog-repeat .gd-schedule-email-dialog-repeat-custom {
  display: flex;
  align-items: center; }
  @media only screen and (max-width: 640px) {
    .gd-schedule-email-dialog-repeat .gd-schedule-email-dialog-repeat-custom {
      flex-wrap: wrap;
      border-left: 2px dotted var(--gd-palette-complementary-3, #dde4eb); } }
  .gd-schedule-email-dialog-repeat .gd-schedule-email-dialog-repeat-custom .gd-schedule-email-dialog-repeat-every {
    margin-left: 20px; }
  .gd-schedule-email-dialog-repeat .gd-schedule-email-dialog-repeat-custom .gd-schedule-email-dialog-repeat-period {
    width: 42px;
    margin-left: 20px; }
    .gd-schedule-email-dialog-repeat .gd-schedule-email-dialog-repeat-custom .gd-schedule-email-dialog-repeat-period .gd-input-field {
      color: var(--gd-palette-complementary-7, #778491);
      font-size: 12px;
      text-align: center;
      padding-right: 0;
      padding-left: 0; }
  .gd-schedule-email-dialog-repeat .gd-schedule-email-dialog-repeat-custom .gd-schedule-email-dialog-repeat-frequency {
    margin-left: 20px; }
  @media only screen and (max-width: 640px) {
    .gd-schedule-email-dialog-repeat .gd-schedule-email-dialog-repeat-custom .break-the-row {
      height: 0;
      flex-basis: 100%; } }
  .gd-schedule-email-dialog-repeat .gd-schedule-email-dialog-repeat-custom .gd-schedule-email-dialog-repeat-execute-on {
    margin-left: 20px; }
    @media only screen and (max-width: 640px) {
      .gd-schedule-email-dialog-repeat .gd-schedule-email-dialog-repeat-custom .gd-schedule-email-dialog-repeat-execute-on {
        margin-top: 10px; } }
...
.gd-recipients-field .gd-recipients__menu {
  padding: 0;
  border-width: 1px;
  border-style: solid;
  ...
  color: var(--gd-palette-complementary-8, #464e56);
  background-color: var(--gd-palette-complementary-0, #fff); }
  .gd-recipients-field .gd-recipients__menu .gd-recipients__option {
    padding: 0; }
  .gd-recipients-field .gd-recipients__menu .gd-recipients__option:first-child.gd-recipients__option--is-focused {
    border-top: 1px solid var(--gd-palette-complementary-4, #ccd8e2); }

.gd-recipients-field .recipient-item-not-valid {
  height: 100%;
  margin: 0;
  padding: 0; }

.gd-recipients-field .gd-recipients__menu-list {
  padding-top: 0;
  padding-bottom: 0; }
  .gd-recipients-field .gd-recipients__menu-list .gd-recipient-option-item {
    padding: 8px 12px; }
    .gd-recipients-field .gd-recipients__menu-list .gd-recipient-option-item .gd-recipient-option-value-item {
      margin-left: 10px;
      color: var(--gd-palette-complementary-5, #b0beca); }
  .gd-recipients-field .gd-recipients__menu-list .gd-recipient-existed {
    display: block;
    width: 100%;
...
.gd-recipients-field .gd-recipients__single-value {
  ...
  .gd-recipients-field .gd-recipients__single-value .gd-recipient-not-valid-bubble {
    margin: 0;
    padding: 0; }
  .gd-recipients-field .gd-recipient-value-item.not-valid,
  .gd-recipients-field .gd-recipients__single-value.not-valid {
    color: var(--gd-palette-complementary-0, #fff);
    background: rgba(229, 77, 66, 0.98); }

.gd-recipients-field .gd-recipients__option--is-focused {
  color: var(--gd-palette-complementary-9, inherit);
  background: none;
  background-color: var(--gd-palette-complementary-2, #ebeff4); }
  .gd-recipients-field .gd-recipients__option--is-focused .gd-message {
    display: block;
    border-radius: 0 0 3px 3px; }

.gd-recipients-field .gd-recipient-option-item.validEmail {
  padding: 0; }
...
.dash-item:hover .is-alert-triggered .dash-item-action-alert {
  color: var(--gd-palette-warning-dimmed40, #8e8642);
  background-color: var(--gd-palette-warning-base-t50, rgba(250, 218, 35, 0.5)); }
...
.dash-item {
  ...
  .dash-item:hover a.kpi-link .kpi-value {
    color: var(--gd-dashboards-content-kpiWidget-kpi-primaryMeasureColor, var(--gd-palette-complementary-9, #6d7680)); }
  .dash-item:hover a.kpi-link .kpi-value.is-empty-value {
    color: var(--gd-dashboards-content-kpiWidget-kpi-secondaryInfoColor, var(--gd-palette-complementary-6, inherit)); }
...
.dash-item-content {
  ...
  justify-content: flex-start;
  max-width: 99.999%;
  /* 100% has issue in IE (wrong kpi width) */ }
...
.viz-type-headline .dash-item-content {
  ...
  background-color: var(--gd-dashboards-content-kpiWidget-backgroundColor, var(--gd-palette-complementary-0, #fff));
...
.is-desktop .dash-item-action-widget-options-active {
  color: var(--gd-palette-complementary-0, #fff);
  background-color: var(--gd-palette-complementary-7, var(--gd-palette-complementary-5, #b0beca)); }
...
.dash-item-action.dash-item-action-options {
  ...
  background-color: var(--gd-palette-complementary-2, #ebeff4);
  transition: 0.2s; }
  .is-mobile .dash-item-action.dash-item-action-alert, .is-mobile
  .dash-item-action.dash-item-action-options {
    display: block; }
...
.has-set-alert .dash-item-action.dash-item-action-alert,
.is-alert-dialog .dash-item-action.dash-item-action-alert,
.dash-item-content:hover .dash-item-action.dash-item-action-alert {
  display: block; }
...
.dash-title {
  ...
  .dash-title.editable:hover, .dash-title.is-editing {
    border-color: var(--gd-palette-complementary-4, rgba(177, 193, 209, 0.5)); }
  .dash-title.placeholder {
    color: var(--gd-palette-complementary-6, #94a1ad); }
...
.gd-drill-modal-picker-dropdown {
  ...
  background-color: var(--gd-palette-complementary-0, #fff);
  border-radius: 3px;
  border: 1px solid var(--gd-palette-complementary-3, #ccd8e2);
  box-shadow: 0 1px 3px 0 var(--gd-shadow-color, rgba(20, 56, 93, 0.1)), 0 2px 9px 0 var(--gd-shadow-color, rgba(20, 56, 93, 0.15)); }
  ...
  .gd-drill-modal-picker-dropdown .gd-drill-modal-picker-list-item {
    ...
    .gd-drill-modal-picker-dropdown .gd-drill-modal-picker-list-item svg {
      ...
      width: 12px;
      height: 100%; }
    .gd-drill-modal-picker-dropdown .gd-drill-modal-picker-list-item:hover, .gd-drill-modal-picker-dropdown .gd-drill-modal-picker-list-item:focus {
      background: var(--gd-palette-complementary-2, #ebeff4); }
      .gd-drill-modal-picker-dropdown .gd-drill-modal-picker-list-item:hover span, .gd-drill-modal-picker-dropdown .gd-drill-modal-picker-list-item:focus span {
...
.configuration-panel {
  width: 100%;
  padding: 10px 0;
  background-color: var(--gd-palette-complementary-0, var(--gd-palette-complementary-2, #ebeff4)); }
...
.gd-configuration-bubble-wrapper.overlay-wrapper {
  z-index: 1000; }
  .gd-configuration-bubble-wrapper.overlay-wrapper.is-sticky {
    z-index: 10; }
  .gd-configuration-bubble-wrapper.overlay-wrapper.target-br {
    z-index: 1000; }
  .gd-configuration-bubble-wrapper.overlay-wrapper .gd-configuration-bubble {
    z-index: 1000;
    width: 251px; }
    .gd-configuration-bubble-wrapper.overlay-wrapper .gd-configuration-bubble.is-sticky {
      z-index: 5; }
    .gd-configuration-bubble-wrapper.overlay-wrapper .gd-configuration-bubble.arrow-right-direction {
      margin-left: 20px; }
    .gd-configuration-bubble-wrapper.overlay-wrapper .gd-configuration-bubble .bubble-content {
      padding: 0; }
      .gd-configuration-bubble-wrapper.overlay-wrapper .gd-configuration-bubble .bubble-content .configuration-panel {
        max-height: 450px;
        overflow-x: hidden;
        overflow-y: auto;
        padding: 0; }
      .gd-configuration-bubble-wrapper.overlay-wrapper .gd-configuration-bubble .bubble-content .configuration-category {
        margin: 15px;
        padding: 0; }
      .gd-configuration-bubble-wrapper.overlay-wrapper .gd-configuration-bubble .bubble-content .configuration-category h3 {
        padding-left: 0; }
      .gd-configuration-bubble-wrapper.overlay-wrapper .gd-configuration-bubble .bubble-content .arrow-position {
        top: 35px; }
      .gd-configuration-bubble-wrapper.overlay-wrapper .gd-configuration-bubble .bubble-content .configuration-panel-header {
        display: flex;
        justify-content: space-between;
        align-items: center;
        width: 100%;
        ...
        background: var(--gd-palette-complementary-2, #ebeff4); }
      .gd-configuration-bubble-wrapper.overlay-wrapper .gd-configuration-bubble .bubble-content .configuration-panel-header-title {
        color: var(--gd-palette-complementary-6, #94a1ad);
        font-size: 11px;
        font-weight: bold;
        text-transform: uppercase; }
      .gd-configuration-bubble-wrapper.overlay-wrapper .gd-configuration-bubble .bubble-content .configuration-panel-header-title.clickable {
        cursor: pointer; }
      .gd-configuration-bubble-wrapper.overlay-wrapper .gd-configuration-bubble .bubble-content .configuration-panel-header-title i {
        font-size: 14px;
        margin-right: 5px;
        position: relative;
        top: 2px; }
      .gd-configuration-bubble-wrapper.overlay-wrapper .gd-configuration-bubble .bubble-content .configuration-panel-header-close-button::before {
        font-size: 12px;
        padding-right: 0;
        margin-right: 0; }
    .gd-configuration-bubble-wrapper.overlay-wrapper .gd-configuration-bubble.arrow-br .bubble-content .arrow-position,
    .gd-configuration-bubble-wrapper.overlay-wrapper .gd-configuration-bubble.arrow-bl .bubble-content .arrow-position {
      top: auto;
      bottom: 35px; }

.configuration-category {
  margin-bottom: 20px; }
  .configuration-category:last-child {
    margin-bottom: 0; }
  .configuration-category h3 {
    ...
    text-transform: uppercase;
    color: var(--gd-palette-complementary-6, #94a1ad); }
    .configuration-category h3.is-disabled {
      color: #c9d5e0; }
    .configuration-category h3::after {
      content: "";
      position: absolute;
      top: 50%;
      display: inline-block;
      ...
      margin-left: 10px;
      border-top: 1px solid var(--gd-palette-complementary-3, #dde4eb); }
    .configuration-category h3 + label {
      margin-top: 10px; }
  .configuration-category > h3:first-child {
    margin-top: 0; }
  .configuration-category label {
    ...
    font-size: 13px;
    color: var(--gd-palette-complementary-7, #6d7680); }
    .configuration-category label + label {
      margin-top: 0; }
    .configuration-category label.filter-by-item {
      display: flex; }
  .configuration-category .gd-input-search {
    margin: 0 15px 10px; }
  .configuration-category .attribute-select {
    margin-top: 10px; }
  .configuration-category .subsection-disabled label {
    color: var(--gd-palette-complementary-5, #b0beca); }
  .configuration-category .warning + h3 {
    margin-top: 10px; }
  .configuration-category .gd-message {
    display: block;
    word-break: break-word;
    overflow-wrap: break-word; }
    .configuration-category .gd-message.error {
      margin: 15px 0;
      padding: 10px;
      font-size: 12px;
      line-height: 18px; }
...
.filter-by-item {
  ...
  align-items: center;
  padding-right: 0; }
  .filter-by-item input,
  .filter-by-item .gd-spinner {
    flex: 0 0 auto; }
  .filter-by-item span {
    flex: 1 1 auto;
    overflow: hidden;
    white-space: nowrap; }
  .filter-by-item .input-label-text {
    display: flex; }
  .filter-by-item .gd-bubble-trigger {
    margin: 0; }
  .filter-by-item .gd-spinner {
    margin-left: 10px; }
...
.date-filter-error .title,
.attribute-filter-error .title {
  color: var(--gd-palette-error-base, #e54d42); }

.is-highlighted {
  border: 1px solid var(--gd-palette-primary-base, #14b2e2) !important;
  box-shadow: 0 0 3px 0 var(--gd-palette-primary-base-t50, rgba(20, 178, 226, 0.5)), 0 1px 2px 0 var(--gd-shadow-color, rgba(20, 56, 93, 0.15));
  color: var(--gd-palette-primary-base, #14b2e2); }

.dataSets-list .gd-list-item-header {
...
.button-remove-drill-to {
  ...
  text-decoration: none; }
  .button-remove-drill-to:hover {
    text-decoration: none; }

.gd-visualizations-list {
  overflow: hidden;
  text-align: left; }
  .gd-visualizations-list .gd-dropdown-tabs {
    margin-left: 15px;
    margin-right: 15px; }
  .gd-visualizations-list .fixedDataTableRowLayout_rowWrapper:hover {
    z-index: 1 !important; }
  .gd-visualizations-list .public_fixedDataTableRow_main,
  .gd-visualizations-list .public_fixedDataTableCell_main {
    background: none; }
  .gd-visualizations-list .gd-visualizations-list-item {
    margin-right: 7px;
    margin-left: 7px;
    padding-right: 10px;
    padding-left: 10px; }
  .gd-visualizations-list .gd-visualizations-list-no-data.gd-no-data {
    margin: 0;
    padding: 10px 20px;
    color: var(--gd-palette-complementary-6, #94a1ad);
    text-align: left; }
    .gd-visualizations-list .gd-visualizations-list-no-data.gd-no-data.gd-visualization-list-not-found {
      text-align: center;
      padding: 0 20px; }
    .gd-visualizations-list .gd-visualizations-list-no-data.gd-no-data .gd-button {
      padding: 0; }
...
.flex-panel-full-vh-height {
  ...
  align-content: stretch;
  height: 100%; }
  .flex-panel-full-vh-height .flex-panel-item-stretch {
    display: flex;
    flex-grow: 1;
    flex-direction: column;
    align-items: stretch;
    align-content: stretch; }
    .flex-panel-full-vh-height .flex-panel-item-stretch .visualizations-list-wrap {
      position: relative;
      flex: 1 1 auto;
      height: 0; }
      .flex-panel-full-vh-height .flex-panel-item-stretch .visualizations-list-wrap .gd-visualizations-list .gd-flex-item-stretch {
        overflow-x: hidden; }

.gd-kpi-date-dataset-dropdown .gd-button {
  width: 159px; }

.metrics-dropdown {
  width: 204px; }
  .metrics-dropdown .dropdown-body {
    flex-direction: column; }

.gd-configuration-bubble-wrapper.overlay-wrapper .gd-configuration-bubble .bubble-content .zoom-and-pan-section {
  margin-top: 10px; }

.zoom-and-pan-section h6 {
  display: none; }

.zoom-and-pan-section .gd-icon-circle-question {
  cursor: help;
  margin-left: -12px;
  margin-top: -3px; }
  .zoom-and-pan-section .gd-icon-circle-question:hover::before {
    color: var(--gd-palette-complementary-5, #999); }
  .zoom-and-pan-section .gd-icon-circle-question::before {
    font: 14px/1 "Indigo", sans-serif;
    color: var(--gd-palette-complementary-5, #bbb); }

.zoom-and-pan-section .input-label-text {
  font-size: 13px;
  color: var(--gd-palette-complementary-8, #464e56); }

.zoom-and-pan-section .gd-message {
  margin-top: 5px; }

.zoom-and-pan-section .input-checkbox-label {
  display: inline-block; }

.edit-insight-config .bubble-content .insight-title .original-insight-title, .edit-insight-config .bubble-content .widget-title > span.insight-title,
...
.edit-insight-config .bubble-content .widget-title {
  ...
  font-weight: bold;
  margin-right: 15px;
  color: var(--gd-palette-complementary-8, #454e56); }
...
.edit-insight-config .bubble-content p.insight-title:hover .original-insight-title {
  padding-right: 5px;
  text-decoration: underline; }

.edit-insight-config .bubble-content p.insight-title:hover .gd-icon-link {
  opacity: 1; }
...
.edit-insight-config .bubble-content .widget-title .insight-title {
  ...
  .edit-insight-config .bubble-content .widget-title .insight-title .original-insight-title {
    ...
    line-height: normal;
    max-width: 190px;
    color: var(--gd-palette-complementary-7, #454e56); }
...
.edit-insight-config .insight-configuration .insight-configuration-panel-header {
  background-color: var(--gd-palette-primary-dimmed, rgba(142, 220, 244, 0.2));
  position: relative;
  padding: 8px 15px; }
...
.edit-insight-config .insight-configuration .gd-menu-wrapper.gd-menu-wrapper-small-spacing .gd-list-item.gd-menu-item {
  ...
  .edit-insight-config .insight-configuration .gd-menu-wrapper.gd-menu-wrapper-small-spacing .gd-list-item.gd-menu-item:hover {
    color: var(--gd-palette-complementary-9, #464e56); }
...
.bubble-light.arrow-left-direction.edit-insight-config-arrow-color .arrow {
  border-right-color: var(--gd-palette-complementary-3, var(--gd-palette-primary-dimmed, rgba(142, 220, 244, 0.2))); }

.bubble-light.arrow-right-direction.edit-insight-config-arrow-color .arrow {
  border-left-color: var(--gd-palette-complementary-3, var(--gd-palette-primary-dimmed, rgba(142, 220, 244, 0.2))); }
...
.gd-configuration-bubble-wrapper.overlay-wrapper .edit-insight-config-arrow-submenu-color .bubble-content .configuration-panel-header {
  padding: 8px 15px; }

.gd-configuration-bubble-wrapper.overlay-wrapper .edit-insight-config-title-1-line .bubble-content .arrow-position {
  top: 9px; }

.gd-configuration-bubble-wrapper.overlay-wrapper .edit-insight-config-title-2-lines .bubble-content .arrow-position {
  top: 18px; }
...
.zoomable .highcharts-selection-marker {
  fill: var(--gd-palette-complementary-1, #b0beca);
  fill-opacity: 0.2; }
