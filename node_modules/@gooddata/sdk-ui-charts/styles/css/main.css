  ...
  .viz-legend .paging {
    ...
    .viz-legend .paging button.paging-button {
      ...
      .viz-legend .paging button.paging-button, .viz-legend .paging button.paging-button:hover, .viz-legend .paging button.paging-button:focus, .viz-legend .paging button.paging-button:active {
        ...
        background-color: var(--gd-palette-complementary-2, #eee); }
        .viz-legend .paging button.paging-button::before, .viz-legend .paging button.paging-button:hover::before, .viz-legend .paging button.paging-button:focus::before, .viz-legend .paging button.paging-button:active::before {
          color: var(--gd-palette-complementary-7, #000); }
      ...
      .viz-legend .paging button.paging-button[disabled], .viz-legend .paging button.paging-button[disabled]:hover, .viz-legend .paging button.paging-button[disabled]:focus, .viz-legend .paging button.paging-button[disabled]:active {
        background-color: var(--gd-palette-complementary-1, rgba(238, 238, 238, 0.5)); }
...
.legend-popup-icon {
  ...
  .legend-popup-icon:hover, .legend-popup-icon.legend-popup-icon-active {
    ...
    .legend-popup-icon:hover #LegendIcoContent, .legend-popup-icon.legend-popup-icon-active #LegendIcoContent {
...
.legend-popup-dialog {
  ...
  .legend-popup-dialog .legend-content {
    flex: 1 1 auto;
    background-color: var(--gd-chart-backgroundColor, var(--gd-palette-complementary-0, white));
    padding: 15px; }
...
.gd-viz-tooltip {
  ...
  border-radius: 3px;
  font-family: gdcustomfont, "Avenir", "Helvetica Neue", arial, sans-serif;
  color: var(--gd-chart-tooltipLabelColor, var(--gd-palette-complementary-6, var(--gd-palette-complementary-9, #000)));
  background-color: var(--gd-chart-tooltipBackgroundColor, var(--gd-palette-complementary-0, rgba(255, 255, 255, 0.95))); }
...
.gd-viz-tooltip-content {
  ...
  border-radius: 3px;
  border: 1px solid;
  border-color: var(--gd-chart-tooltipBorderColor, var(--gd-palette-complementary-3, rgba(201, 213, 224, 0.7)));
...
.gd-viz-tooltip-title {
  ...
  text-overflow: ellipsis;
  text-align: left;
  color: var(--gd-chart-tooltipLabelColor, var(--gd-palette-complementary-7, #6d7680)); }
...
.gd-viz-tooltip-value {
  ...
  color: var(--gd-chart-tooltipValueColor, var(--gd-palette-complementary-9, #000)); }
  ...
  .gd-viz-tooltip-value::after {
    ...
    height: 1em;
    margin-top: 0.2em;
    background: var(--gd-chart-tooltipBackgroundColor, var(--gd-palette-complementary-0, rgba(255, 255, 255, 0.95))); }
...
.headline-compare-section.headline-paginated-compare-section button.second-item {
  ...
  .headline-compare-section.headline-paginated-compare-section button.second-item:hover::before {
    color: var(--gd-palette-primary-base, #14b2e2); }
  .headline-compare-section.headline-paginated-compare-section button.first-item[disabled], .headline-compare-section.headline-paginated-compare-section button.first-item[disabled]:hover, .headline-compare-section.headline-paginated-compare-section button.first-item[disabled]:focus, .headline-compare-section.headline-paginated-compare-section button.first-item[disabled]:active,
  .headline-compare-section.headline-paginated-compare-section button.second-item[disabled],
  .headline-compare-section.headline-paginated-compare-section button.second-item[disabled]:hover,
  .headline-compare-section.headline-paginated-compare-section button.second-item[disabled]:focus,
  .headline-compare-section.headline-paginated-compare-section button.second-item[disabled]:active {
    background-color: var(--gd-palette-complementary-1, rgba(238, 238, 238, 0.5)); }
    .headline-compare-section.headline-paginated-compare-section button.first-item[disabled]::before, .headline-compare-section.headline-paginated-compare-section button.first-item[disabled]:hover::before, .headline-compare-section.headline-paginated-compare-section button.first-item[disabled]:focus::before, .headline-compare-section.headline-paginated-compare-section button.first-item[disabled]:active::before,
    .headline-compare-section.headline-paginated-compare-section button.second-item[disabled]::before,
    .headline-compare-section.headline-paginated-compare-section button.second-item[disabled]:hover::before,
    .headline-compare-section.headline-paginated-compare-section button.second-item[disabled]:focus::before,
    .headline-compare-section.headline-paginated-compare-section button.second-item[disabled]:active::before {
      color: var(--gd-palette-complementary-5, #b0beca); }
...
.headline-compare-section.gd-small, .headline-compare-section.gd-shortened-label {
  ...
  .headline-compare-section.gd-small .kpi-pop-section-item, .headline-compare-section.gd-shortened-label .kpi-pop-section-item {
    ...
    .headline-compare-section.gd-small .kpi-pop-section-item.kpi-pop-period, .headline-compare-section.gd-shortened-label .kpi-pop-section-item.kpi-pop-period {
      border-left: 0;
      border-bottom: 1px dashed var(--gd-dashboards-content-kpiWidget-kpi-secondaryInfoColor, var(--gd-palette-complementary-3, rgba(176, 190, 202, 0.5)));
      padding: 0 0 10px;
      text-align: center; }
    .headline-compare-section.gd-small .kpi-pop-section-item > dd, .headline-compare-section.gd-shortened-label .kpi-pop-section-item > dd {
      ...
      white-space: nowrap;
      text-overflow: ellipsis; }
  .headline-compare-section.gd-small .headline-tertiary-item, .headline-compare-section.gd-shortened-label .headline-tertiary-item {
    padding: 10px 0 0;
    text-align: center; }
  .headline-compare-section.gd-small .headline-secondary-item, .headline-compare-section.gd-shortened-label .headline-secondary-item {
    border-left: 0;
    border-bottom: 1px dashed var(--gd-kpi-secondaryInfoColor, var(--gd-palette-complementary-3, rgba(176, 190, 202, 0.5)));
    padding: 0 0 10px;
    text-align: center; }
...
.headline {
  ...
  .headline .headline-primary-item {
    ...
    .headline .headline-primary-item .headline-value--empty {
      color: var(--gd-kpi-secondaryInfoColor, var(--gd-palette-complementary-6, #b0beca)); }
  .headline .headline-secondary-item {
    flex-shrink: 1;
    padding-right: 0;
    border-left: 1px dashed var(--gd-kpi-secondaryInfoColor, var(--gd-palette-complementary-3, rgba(176, 190, 202, 0.5))); }
  ...
  .headline .headline-compare-section {
    ...
    margin-top: 10px;
    margin-bottom: 15px;
    color: var(--gd-kpi-secondaryInfoColor, var(--gd-palette-complementary-6, #94a1ad)); }
