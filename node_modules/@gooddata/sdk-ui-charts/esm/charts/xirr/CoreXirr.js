...
var XirrStateless = /** @class */ (function (_super) {
    __extends(XirrStateless, _super);
    function XirrStateless(props) {
        var _this = _super.call(this, props) || this;
        _this.errorMap = newErrorMapping(props.intl);
        return _this;
    }
    XirrStateless.prototype.render = function () {
    ...
    XirrStateless.prototype.renderVisualization = function () {
        ...
        return (React.createElement(IntlWrapper, { locale: locale },
            React.createElement(IntlTranslationsProvider, null, function (props) {
                ...
                return (React.createElement(XirrTransformation, { dataView: dataView, onAfterRender: afterRender, onDrill: onDrill, drillableItems: drillableItems, config: config }));
            })));
    };
    XirrStateless.defaultProps = defaultCoreChartProps;
    return XirrStateless;
}(React.Component));
 ...
 * @internal
 */
export var CoreXirr = withEntireDataView(XirrStateless);
