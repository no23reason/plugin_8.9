...
export declare type OnExecutionTransformed = (newExecution: IPreparedExecution) => void;
export declare type OnTransformedExecutionFailed = () => void;
export declare type TableLegacyCallbacks = {
    pushData: (data: IPushData) => void;
};
/**
 * Callbacks for table / data loading.
 */
export declare type TableDataCallbacks = {
 ...
 */
export declare type TableConfigAccessors = {
 ...
 */
export declare type TableAgGridCallbacks = {
 ...
 */
export declare type TableMenuCallbacks = {
 ...
 */
export declare type TableMethods = TableDataCallbacks & TableLegacyCallbacks & TableConfigAccessors & TableAgGridCallbacks & TableMenuCallbacks;
export declare type ColumnResizingConfig = {
    defaultWidth: number;
    growToFit: boolean;
...
export declare type StickyRowConfig = {
