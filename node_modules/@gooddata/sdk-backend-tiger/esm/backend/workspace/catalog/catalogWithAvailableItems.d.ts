import { IWorkspaceCatalogWithAvailableItems, CatalogItem, ICatalogGroup, ICatalogAttribute, ICatalogMeasure, ICatalogFact, ICatalogDateDataset } from "@gooddata/sdk-backend-spi";
export declare class TigerWorkspaceCatalogWithAvailableItems implements IWorkspaceCatalogWithAvailableItems {
    ...
    constructor(catalogGroups: ICatalogGroup[], items: CatalogItem[], availableItems: CatalogItem[]);
